...
unified-extensions-item-messagebar-softblocked = { $extensionName } 違反了 BrowserWorks 的政策規定，繼續使用可能會有風險。
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        此擴充套件違反了 BrowserWorks 的政策，已被停用。
        您還是可以到設定畫面中開啟，但可能會有風險。
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = 已停用 { $extensionName }
    .message = 此擴充套件違反了 BrowserWorks 的政策，已被停用。
# Variables:
#   $extensionsCount (Number) - Number of extensions disabled through both soft and hard-blocks (always going to be greater than 1)
unified-extensions-mb-blocklist-warning-multiple =
    .heading = 已停用 { $extensionsCount } 組擴充套件
    .message =
        您有一些擴充套件違反了 BrowserWorks 的政策，已被停用。
        您還是可以到設定畫面中開啟，但可能會有風險。
# Variables:
#   $extensionsCount (Number) - Number of extensions disabled through hard-blocks.
unified-extensions-mb-blocklist-error-multiple =
    .heading = 已停用 { $extensionsCount } 組擴充套件
    .message = 您有一些擴充套件違反了 BrowserWorks 的政策，已被停用。
