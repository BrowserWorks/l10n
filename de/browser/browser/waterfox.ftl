...
waterfox-blocker-dropdown-option-partner-exception =
    .label = Suchpartner in Waterfox zulassen
...
waterfox-blocker-custom-filter-lists-dialog =
    .buttonlabelaccept = Änderungen speichern
    .buttonaccesskeyaccept = s
waterfox-blocker-custom-filter-lists-description = Fügt URLs für benutzerdefinierte Filterlisten hinzu. Die Listen werden abgerufen und zusätzlich zu den integrierten Filtern angewendet.
...
waterfox-blocker-partner-funding-description = Waterfox ist kostenlos, Open Source und unabhängig. Durch die Anzeige von Werbung auf den Seiten unserer Suchpartner finanziert Waterfox die Entwicklung und die Infrastruktur. Sie können diese Funktion jederzeit deaktivieren, doch wenn Sie sie aktiviert lassen, unterstützen Sie das Projekt auf einfachste Weise.
