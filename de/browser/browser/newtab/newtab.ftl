...
newtab-settings-button =
    .title = Waterfox-Startseite anpassen
...
newtab-personalize-icon-label =
    .title = Waterfox-Startseite anpassen
    .aria-label = Waterfox-Startseite anpassen
...
newtab-wallpaper-feature-highlight-content = Geben Sie Ihrer Waterfox-Startseite einen frischen Anstrich mit Hintergrundbildern.
...
newtab-weather-menu-hide-weather = Wetter auf der Waterfox-Startseite ausblenden
...
newtab-new-user-custom-wallpaper-subtitle = Fühlen Sie sich auf Ihrer Waterfox-Startseite wie zu Hause — mit benutzerdefinierten Hintergrundbildern und Farben.
