...
cert-error-mitm-mozilla = { -brand-short-name } کوں غیر منافع بخش BrowserWorks دی حمایت حاصل ہے، جیڑھا ہک مکمل طور تے اوپن سرٹیفکیٹ اتھارٹی (CA) سٹور دا انتظام کریندا ہے۔ CA سٹور ایں ڳالھ کوں یقینی بݨاوݨ وِچ مدد کریندا ہے جو سرٹیفکیٹ حکام صارف دی حفاظت کیتے بہترین طریقیاں تے عمل کر یندے ہن۔
cert-error-mitm-connection = { -brand-short-name } صارف دے آپریٹنگ سسٹم دی طرفوں فراہم کردہ سرٹیفکیٹس دی بجائے ایں ڳالھ دی تصدیق کرݨ کیتے موزیلا CA سٹور دا استعمال کریندا ہے جو کنکشن محفوظ ہے۔ لہذا، جے کوئی اینٹی وائرس پروگرام یا نیٹ ورک کہیں CA دی طرفوں جاری کردہ سیکورٹی سرٹیفکیٹ دے نال کہیں کنکشن کوں روکیندا ہے جیڑھا BrowserWorks CA سٹور وِچ کائنی، تاں کنکشن کوں غیر محفوظ سمجھا ویندا ہے۔
