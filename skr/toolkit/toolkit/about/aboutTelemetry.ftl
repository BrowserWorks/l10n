...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Waterfox ڈیٹا دستاویزی</a> وِچ اساݙے ڈیٹا ٹولز دے نال کم کرݨ دے طریقے دے بارے گائیڈز موجود ہن۔
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox Telemetry کلائنٹ دستاویزات</a> وِچ تصورات، API دستاویزات تے ڈیٹا حوالہ جات دیاں تعریفاں شامل ہن۔
