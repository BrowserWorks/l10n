...
waterfox-tabs-tree-auto-collapse-on-select-toggle =
    .label = При виборі вкладки, автоматично розгортати її гілку та згортати усі інші
...
waterfox-tree-disclosure-collapse = Згорнути дерево для { $tabTitle }
waterfox-tree-disclosure-expand = Розгорнути дерево для { $tabTitle }
waterfox-tabs-tree-expand-native-group-toggle =
    .label = Розгортання гілки також розгортає її групу вкладок
waterfox-tabs-tree-successor-toggle =
    .label = Враховувати ієрархію вкладок під час вибору наступної активної вкладки після закриття
waterfox-tabs-tree-drop-links-select =
    .label = При перетягуванні посилань на вкладку
waterfox-tabs-tree-drop-links-option-load =
    .label = Відкривати у тій вкладці
waterfox-tabs-tree-drop-links-option-ask =
    .label = Щоразу питати
waterfox-tabs-tree-drop-links-option-child =
    .label = Відкривати як дочірні вкладки
waterfox-tabs-tree-indent-input =
    .label = Відступ для кожного рівня (у пікселях)
    .description = Додатковий відступ для кожного рівня вкладеності, щонайменше 1 піксель.
waterfox-tabs-tree-limit-depth-toggle =
    .label = Обмежити рівень вкладеності вкладок
    .description = Вимкніть, щоб дозволити необмежену вкладеність.
waterfox-tabs-tree-max-depth-input =
    .label = Найбільший рівень вкладеності
    .description = Вкладки верхнього рівня мають рівень 0. Наявні гілки не перебудовуються.
