...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Увімкніть налагодження через USB у Waterfox на пристрої Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ця версія Waterfox не може налагодити Waterfox для Android (68). Радимо встановити Waterfox для Android Nightly на ваш телефон для тестування. <a>Детальніше</a>
...
about-debugging-browser-version-too-recent = Під'єднаний браузер є новішим ({ $runtimeVersion }, buildID { $runtimeID }), ніж ваш { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Ця конфігурація не підтримується і може призвести до збою DevTools. Будь ласка, оновіть Waterfox. <a>Розв'язання проблем</a>
