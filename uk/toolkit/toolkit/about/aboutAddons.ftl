...
discopane-intro3 =
    ...
    перелік <a data-l10n-name="learn-more-trigger">рекомендованих розширень</a> Waterfox
...
addon-badge-recommended4 =
    .title = Waterfox рекомендує лише ті розширення, які відповідають стандартам безпеки та продуктивності.
...
recommended-theme-1 = Відчуваєте творче натхнення? <a data-l10n-name="link">Створіть власну тему за допомогою Waterfox Color.</a>
