...
process-type-web = ខ្លឹមសារគេហទំព័រ
# process used to run privileged about pages,
# such as about:home
process-type-privilegedabout = ឯកសិទ្ធិអំពី
# process used to run privileged mozilla pages,
# such as accounts.firefox.com
process-type-privilegedmozilla = មាតិកា BrowserWorks ដែលមានសិទ្ធិ
process-type-extension = ផ្នែក​បន្ថែម
# process used to open file:// URLs
process-type-file = ឯកសារក្នុងស្រុក
# process used to instantiate new child processes
process-type-forkserver = ម៉ាស៊ីនមេ Fork
# process used to isolate a webpage from other web pages
# to improve security
process-type-webisolated = មាតិកាគេហទំព័រដាច់ដោយឡែក
