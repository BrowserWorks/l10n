...
removed-search-engine-message2 = <strong>デフォルト検索エンジンが変更されました。</strong>{ -brand-short-name } は { $oldEngine } への対応を終了しました。{ $newEngine } が新しいデフォルト検索エンジンになります。設定を開くと他の検索エンジンに変更できます。
...
reset-search-settings-message = 技術的な問題により、デフォルト検索エンジンを { $newEngine } に初期化しました。設定からデフォルト検索エンジンを変更できます。
...
add-engine-name-placeholder =
    .placeholder = 例: BrowserWorks Developer Network
