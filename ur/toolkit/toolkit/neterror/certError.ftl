...
cert-error-mitm-mozilla = { -brand-short-name }کی حمایت غیر منافع بخش BrowserWorks کرتا ہے، جو مکمل طور پر کھلا سرٹیفکیٹ اتھارٹی (CA) اسٹور کا انتظام کرتی ہے۔ CA اسٹور اس بات کو یقینی بنانے میں مدد کرتا ہے کہ سرٹیفکیٹ حکام صارف سیکورٹی کے لئے بہترین طریقوں پر عمل کریں۔
cert-error-mitm-connection = اس بات کی تصدیق کرنے کے لئے کہ کنکشن محفوظ ہے { -brand-short-name } BrowserWorks کے CA اسٹور کا استعمال کرتاہے، صارف کی آپریٹنگ سسٹم کی طرف سے فراہم کردہ سرٹیفکیٹ کے بجائے۔ لہذا، اگر ایک اینٹی وایرس پروگرام یا نیٹ ورک CA کی طرف سے جاری سیکیورٹی سرٹیفکیٹ کے ساتھ کنکشن کو روک رہا ہے جو  BrowserWorks CA سٹور میں نہیں ہے، تو کنکشن کو محفوظ نہیں سمجھا جاتا ہے۔
