...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Միացնել USB կարգաբերումը Waterfox- ում Android սարքի վրայ:
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Waterfox-ի այս տարբերակը չի կարող վրիպազերծել Waterfox-ը  Android (68)-ի համար: Խորհուրդ է տրուում փորձարկելու համար Ձեր հեռախաւսում տեղադրել Waterfox Android Nightly: <a>Լրացուցիչ մանրամասներ</a>
...
about-debugging-browser-version-too-recent = Միացուած զննարկիչն աւելի նոր ({ $runtimeVersion } է, buildID{ $runtimeID }) քան ձեր { -brand-shorter-name } ({ $localVersion }, buildID { $localID })։ Սա անհամատեղելի կարգաւորում է եւ DevTools-ը կարող է խափանուել։ Խնդրում ենք թարմացրել Waterfox-ը, <a>Անսարքութիւնների կարգաւորում</a>
