...
protections-panel-not-blocking-why-etp-off-tooltip-label =
    .label = Այս կայքի բոլոր հետքերը բեռնուած են, քանի որ պաշտպանութիւնն անջատուած է։
