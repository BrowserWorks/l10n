...
identity-custom-root = Կապակցումը հաստատուել է վկայագրի թողարկողի կողմից, որը ճանաչուած չէ BrowserWorks֊ի կողմից։
...
identity-description-custom-root2 = BrowserWorks֊ն չի ճանաչում այս վկայագրի թողարկողին։ Այն հնարաւոր է աւելացուել է Ձեր գործաւարական համակարգից կամ վարիչի կողմից։
...
urlbar-searchmode-popup-add-engine = Աւելացնել « { $engineName } »-ը
    .title = Աւելացնել « { $engineName } » որոնման ծրագիրը
