...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link"> Waterfox-ի տուեալների փաստաթղթաւորումը</a> պարունակում է ուղղորդներ` մեր տուեալների գործիքների հետ աշխատելու համար։
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox-ի հեռուսաչափութեան սպասառուի փաստաթղթաւորումը</a> ներառում է հակացուցումների սահմանումներ , API փաստաթղթաւորում եւ տուեալների յղումներ։
