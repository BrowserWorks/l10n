...
sync-mobile-promo = Iscàrriga Waterfox pro <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o pro <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> pro sincronizare cun su dispositivu mòbile tuo.
...
sync-engine-addresses =
    .label = Indiritzos
    .tooltiptext = Indiritzos postales chi as sarvadu (isceti in Waterfox de iscrivania)
    .accesskey = n
sync-engine-creditcards =
    .label = Cartas de crèditu
    .tooltiptext = Nòmines, nùmeros e iscadèntzias (isceti in Waterfox de iscrivania)
    .accesskey = C
...
sync-engine-addons =
    .label = Cumplementos
    .tooltiptext = Estensiones e temas pro Waterfox de iscrivania
    .accesskey = u
