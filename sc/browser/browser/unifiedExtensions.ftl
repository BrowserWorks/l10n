...
unified-extensions-item-messagebar-softblocked = { $extensionName } vìolat is polìticas de BrowserWorks. A dda impreare podet èssere perigulosu.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message = Custa estensione vìolat is polìticas de BrowserWorks e est istada disativada. Dda podes ativare in sa cunfiguratzione, ma podet èssere perigulosu.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } disativada
    .message = Custa estensione vìolat is polìticas de BrowserWorks e est istada disativada.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message = Unas cantas estesiones sunt istadas disativadas ca vìolant is polìticas de BrowserWorks. Ddas podes ativare in sa cunfiguratzione, ma podet èssere perigulosu.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Unas cantas estesiones sunt istadas disativadas ca vìolant is polìticas de BrowserWorks.
