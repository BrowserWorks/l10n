...
addon-install-error-hard-blocked = { $addonName } vìolat is polìticas de BrowserWorks e non si podet installare in { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } vìolat is polìticas de BrowserWorks e non si podet installare in { -brand-short-name }.
