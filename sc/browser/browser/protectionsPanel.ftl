...
protections-panel-content-blocking-breakage-report-view-description = Blocare unos cantos sighidores podet causare problemas cun unos cantos sitos. Sinnalare custos problemas agiudat a megiorare { -brand-short-name } pro totus. Custu informe chi as a imbiare a BrowserWorks at a incluire s'URL de su situ e informatziones subra de is cunfiguratziones tuas pro su navigadore. <label data-l10n-name="learn-more">Àteras informatziones</label>
