...
identity-custom-root = Connessione verificada dae un'emitente de tzertificados non reconnotu dae BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks non reconnoschet custu emitente de tzertificatzione. Diat pòdere èssere istadu agiuntu dae su sistema operativu o dae s'amministratzione.
