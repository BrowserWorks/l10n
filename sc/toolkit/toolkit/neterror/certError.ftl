...
cert-error-mitm-mozilla = { -brand-short-name } est suportadu dae BrowserWorks, organizatzione chene profetu chi gestit unu depòsitu de autoridade de tzertificatzione de su totu abertu (CA). Su depòsitu CA agiudat a garantire chi is autoridades de tzertificatzione siant sighende pràticas seguras pro s'amparu de is utentes.
cert-error-mitm-connection = { -brand-short-name } impreat su magasinu de CA de BrowserWorks pro verificare chi una connessione siat segura, imbetzes de impreare tzertificados frunidos dae su sistema operativu de s'usuàriu. Duncas, si unu programma anti-virus o una rete de traballu est intertzetende una connessione cun unu tzertificadu de seguresa emìtidu dae unu CA chi non est in su magasinu CA de BrowserWorks, sa connessione est cunsiderada non segura.
