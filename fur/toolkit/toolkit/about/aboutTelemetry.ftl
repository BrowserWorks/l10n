...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">documentazion dai dâts di Waterfox</a> e inclût vuidis su cemût lavorâ cui nestris imprescj pe gjestion dai dâts.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentazion dal client di Waterfox Telemetry</a> a inclût definizions di concets, documentazion API e referencis di dâts.
