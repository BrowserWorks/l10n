...
discopane-intro3 =
    ...
    tu cjatis une selezion di elements <a data-l10n-name="learn-more-trigger">conseâts</a> di Waterfox
...
addon-badge-recommended4 =
    .title = Waterfox al consee dome estensions che a sodisfin i standards di sigurece e di prestazion
...
recommended-theme-1 = Ti sintistu creatîf? <a data-l10n-name="link">Dissegne il to teme cun Waterfox Color.</a>
