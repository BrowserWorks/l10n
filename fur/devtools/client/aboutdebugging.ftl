...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Ative lis operazions di debug vie USB in Waterfox sul dispositîf Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Cheste version di Waterfox no pues esegui il debug a Waterfox par Android (68). O conseìn di instalâ Waterfox par Android Nightly sul to telefon par provâ. <a>Plui detais</a>
