...
addon-install-error-hard-blocked = { $addonName } al viole lis politichis di BrowserWorks e nol è pussibil instalâlu in { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } al viole lis politichis di BrowserWorks e nol è pussibil instalâlu in { -brand-short-name }.
