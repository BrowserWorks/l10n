...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } al viole lis politichis di BrowserWorks. La sô utilizazion e podarès compuartâ risis.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Cheste estension e viole lis politichis di BrowserWorks e e je stade disativade.
        Tu puedis ativâle tes impostazions, ma chest al compuarte risis.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } disativât
    .message = Cheste estension e viole lis politichis di BrowserWorks e e je stade disativade.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Cualchidune des tôs estensions e je stade disativade parcè che e viole lis politichis di BrowserWorks.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Cualchidune des tôs estensions e je stade disativade parcè che e viole lis politichis di BrowserWorks.
