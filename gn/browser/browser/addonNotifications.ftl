...
addon-install-error-hard-blocked = { $addonName } omomarã BrowserWorks porureko ha ndaikatúi emohenda { -brand-short-name } rupive.
...
addon-install-error-soft-blocked = { $addonName } omomarã BrowserWorks porureko ha ndaikatúi emohenda { -brand-short-name } rupive.
