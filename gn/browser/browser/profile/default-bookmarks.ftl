...
default-bookmarks-firefox-customize = Emboava Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Eike pype
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Ore rehegua
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly Mba’eita
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog Waterfox Nightly mba’e
