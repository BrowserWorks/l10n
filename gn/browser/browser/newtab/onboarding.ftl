...
onboarding-animation-pause-button =
    .aria-label = Ñemombyta mokyre’ỹ
onboarding-animation-play-button =
    .aria-label = Ñemongu’e mokyre’ỹ
...
mr2022-onboarding-gratitude-subtitle = Aguyje eiporu haguére { -brand-short-name }, oykekóva Fundación BrowserWorks. Nepytyvõ rupive, romba’apo ñanduti ijuruja hag̃ua, ojeporukuaáva ha iporãvéva opavavépe g̃uarã.
...
onboarding-gratitude-security-and-privacy-subtitle = Aguyje eiporu haguére { -brand-short-name }, oykekóva Fundación BrowserWorks. Nepytyvõ rupive, romba’apo Ñanduti hekorosã ha ijuruja hag̃ua opavavetépe g̃uarã.
...
onboarding-refresh-pin-set-default-subtitle = Romo’ã ne mba’ekuaarãita ha rojoko opaite mba’apohaguasu oma’ẽñemíva eikehápe rehe.
# "safe paws" is a play on "safe hands", meaning you're being well taken care of or protected
# If it doesn’t translate well, you can use the alternative: “You’re safe with Firefox.”
onboarding-refresh-pin-set-default-title = Eime eime hag̃uáme
onboarding-refresh-import-subtitle = Eru ne ñe’ẽñemieta, techaukaha, tembiasakue ha hetave.
