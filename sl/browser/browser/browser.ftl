...
urlbar-result-menu-button-feedback = Povratne informacije
    .title = Odpri meni
urlbar-result-menu-learn-more2 = Več o tem
    .accesskey = V
urlbar-result-menu-remove-from-history2 = Odstrani iz zgodovine
    .accesskey = O
...
clear-search-history =
    .label = Počisti zgodovino iskanj
    .accesskey = P
...
search-one-offs-context-set-as-default =
    .label = Nastavi kot privzeti iskalnik
    .accesskey = P
...
identity-custom-root = Povezavo je preveril izdajatelj digitalnega potrdila, ki ga BrowserWorks ne prepozna.
...
identity-description-custom-root2 = BrowserWorks ne prepozna tega izdajatelja digitalnih potrdil. Morda ga je dodal vaš operacijski sistem ali skrbnik.
...
qrcode-panel-error =
    .message = Kode QR ni bilo mogoče ustvariti. Poskusite znova.
qrcode-copy-button =
    .label = Kopiraj
qrcode-copy-success =
    .message = Koda QR kopirana v odložišče.
qrcode-copy-error =
    .message = Kode QR ni bilo mogoče kopirati.
qrcode-save-button =
    .label = Shrani
qrcode-save-success =
    .message = Koda QR shranjena.
qrcode-save-error =
    .message = Kode QR ni bilo mogoče shraniti.
qrcode-save-title = Shrani kodo QR
qrcode-save-filter-png = Slika PNG
qrcode-save-filename = koda_qr.png
qrcode-window-title = Koda QR
qrcode-dialog-title = Koda QR
qrcode-image =
    .aria-label = Koda QR
qrcode-close-button =
    .aria-label = Zapri
...
menu-share-copy-links =
    .label =
        { $count ->
            [one] Kopiraj povezavo
            [two] Kopiraj { $count } povezavi
            [few] Kopiraj { $count } povezave
