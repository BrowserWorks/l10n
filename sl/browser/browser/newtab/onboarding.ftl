...
onboarding-animation-pause-button =
    .aria-label = Ustavi animacijo
onboarding-animation-play-button =
    .aria-label = Predvajaj animacijo
...
mr2022-onboarding-gratitude-subtitle = Hvala, ker uporabljate { -brand-short-name }, ki ga podpira BrowserWorks. Z vašo podporo si prizadevamo narediti internet bolj odprt, dostopen in boljši za vse.
...
onboarding-gratitude-security-and-privacy-subtitle = Hvala, ker uporabljate { -brand-short-name }, ki ga podpira BrowserWorks. Z vašo podporo si prizadevamo narediti internet varnejši in dostopnejši za vse.
