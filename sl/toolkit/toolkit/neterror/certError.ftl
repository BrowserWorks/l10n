...
cert-error-mitm-mozilla = { -brand-short-name } podpira neprofitna organizacija BrowserWorks, ki upravlja popolnoma odprto zbirko overiteljev potrdil (CA). Zbirka CA pomaga zagotoviti, da overitelji potrdil sledijo najboljšim praksam za varnost uporabnikov.
