...
cert-error-mitm-mozilla = { -brand-short-name } tettwaḥrez sɣur takebbanit BrowserWorks ur ittnadin ara ɣef rbeḥ, isefraken alzuz n iselkinen yeldin s umata (CA). Alzuz n iselkinen CA ittmudu-d tallelt i suqdec deg taɣelist.
cert-error-mitm-connection = { -brand-short-name } iseqdac alzuz CA BrowserWorks akken ad isenqed tuqqna taɣelsant, deg wadeg n iselkinen n unagraw n wamud n useqdac, ihi ma yella useɣẓan n mgalavirus neɣ aẓeṭṭa iseqdac aselkin mačči n BrowserWorks ihi tuqqna ad tettwaḥsab mačči d taɣelsant.
