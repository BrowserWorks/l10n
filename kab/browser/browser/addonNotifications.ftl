...
addon-install-error-hard-blocked = { $addonName } ur iquder ara tasertit n BrowserWorks, ur yezmir ara ad yettusbedd ɣef { -brand-short-name }.
addon-install-error-blocklisted = { $addonName } ur yezmir ara ad yebded acku yella wugur meqqren n tɣellist d urkad.
addon-install-error-soft-blocked = { $addonName } ur iquder ara tasertit n BrowserWorks, ur yezmir ara ad yettusbedd ɣef { -brand-short-name }.
