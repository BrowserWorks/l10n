...
unified-extensions-item-messagebar-softblocked = { $extensionName } ur iquder ara tasertit n BrowserWorks. Aseqdec-is yezmer ad d-yeglu s wuguren.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message = Asiɣzef-a yetεedda ɣer tsertit n BrowserWorks ɣef waya yensa.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } yensa
    .message = Asiɣzef-a ur iqudar ara tisertiyin n BrowserWorks, ɣef waya i yensa.
