...
default-bookmarks-firefox-customize = Sagen Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ttekki
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Fell-aɣ
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Tiɣbula n Waterfox Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Ablug n Waterfox Nightly
