...
addon-badge-recommended4 =
    .title = Waterfox recommenda solmente le extensiones que satisface le standards de securitate e prestation
...
recommended-theme-1 = Te senti creative? <a data-l10n-name="link">Crea tu proprie thema con Waterfox Color.</a>
