...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } viola le directivas de BrowserWorks. Usar lo pote esser riscose.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } disactivate
    .message =
        Iste extensiones viola le directivas de BrowserWorks e ha essite disactivate.
        Tu pote activar los in parametros, ma isto pote esser riscose.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } disactivate
    .message = Iste extension viola le directivas de BrowserWorks e ha essite disactivate.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Alcun de tu extensiones viola le directivas de BrowserWorks e ha essite disactivate.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Alcun de tu extensiones viola le directivas de BrowserWorks e ha essite disactivate.
