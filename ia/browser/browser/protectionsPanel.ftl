...
protections-panel-content-blocking-breakage-report-view-description = Blocar certe traciatores pote causar problemas con alcun sitos web. Reportar iste problemas adjuta a meliorar { -brand-short-name } pro totes. Le invio de iste reporto transmittera a BrowserWorks un URL e informationes sur le configuration de tu navigator. <label data-l10n-name="learn-more">Saper plus</label>
