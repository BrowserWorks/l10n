...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activar le Depuration USB in Waterfox sur le apparato Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Iste version de Waterfox non pote depurar Waterfox pro Android (68). Nos recommenda installar Waterfox pro Android Nightly sur tu telephono pro facer tests. <a>Plus detalios</a>
...
about-debugging-browser-version-too-recent = Le navigator connexe es plus recente ({ $runtimeVersion }, buildID { $runtimeID }) que tu { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Isto es un installation non supportate e pote causar faltas in DevTools. Actualisa Waterfox. <a>Resolution de problemas</a>
