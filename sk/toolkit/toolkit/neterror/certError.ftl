...
cert-error-mitm-mozilla = Za { -brand-short-name(case: "ins") } stojí nezisková organizácia BrowserWorks, ktorá spravuje otvorené úložisko certifikačných autorít (CA). Toto úložisko zaisťuje, že certifikačné autority dodržiavajú osvedčené bezpečnostné postupy.
