...
addon-badge-line3 =
    .title = Oficiálne rozšírenie od autorov Waterfoxu. Spĺňa bezpečnostné a výkonové štandardy.
...
addon-badge-recommended4 =
    .title = Waterfox odporúča len rozšírenia, ktoré spĺňajú štandardy pre bezpečnosť a výkon
...
recommended-theme-1 = Ste tvoriví? <a data-l10n-name="link">Vytvorte si svoju vlastnú tému vzhľadu pomocou Waterfox Color.</a>
