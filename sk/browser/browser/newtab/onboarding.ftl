...
mr2022-onboarding-gratitude-subtitle = Ďakujeme, že používate { -brand-short-name(case: "acc") }, ktorý podporuje BrowserWorks. S vašou podporou pracujeme na tom, aby bol internet otvorenejší, prístupnejší a lepší pre každého.
...
onboarding-gratitude-security-and-privacy-subtitle = Ďakujeme, že používate { -brand-short-name(case: "acc") } podporovaný BrowserWorks. S vašou podporou pracujeme na tom, aby bol internet bezpečnejší a prístupnejší pre každého.
