...
opensearch-error-duplicate-desc = Aplikácii { -brand-short-name } sa nepodarilo nainštalovať vyhľadávač z “{ $location-url }”, pretože vyhľadávač s rovnakým názvom už existuje.
opensearch-error-format-title = Neplatný formát
opensearch-error-format-desc = Aplikácii { -brand-short-name } sa nepodarilo nainštalovať vyhľadávač z { $location-url }
opensearch-error-download-title = Chyba pri sťahovaní
opensearch-error-download-desc = Aplikácii { -brand-short-name } sa nepodarilo sťiahnuť vyhľadávač z { $location-url }
...
reset-search-settings-message = Kvôli technickému problému bol váš predvolený vyhľadávač zmenený späť na { $newEngine }. Ak chcete zmeniť predvolený vyhľadávač, prejdite do nastavení.
...
install-search-engine = Pridať { $engineName } ako vyhľadávač?
...
add-engine-name-placeholder =
    .placeholder = napr. BrowserWorks Developer Network
