...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Включете отдалеченото отстраняване на дефекти през USB във Waterfox на устройството с Андроид.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Това издание на Waterfox не може да отстранява дефекти от Waterfox за Android (68). Препоръчваме ви за проба да инсталирате Waterfox за Android Nightly на устройството. <a>Подробности</a>
...
about-debugging-browser-version-too-recent = Свързаният браузър е по-нов ({ $runtimeVersion }, buildID { $runtimeID }) отколкото вашият { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Тази комбинация не се поддържа и е възможно инструментите за разработчици да покажат грешка. Моля, обновете Waterfox. <a>Отстраняване на грешки</a>
