...
appmenuitem-relay-description = Скрийте истинските си електронна поща и телефонен номер
...
# Mozilla.
appmenu-other-protection-header2 = Опитайте други защитни инструменти от BrowserWorks:
