...
addon-install-error-hard-blocked = Добавката { $addonName } нарушава правилата на BrowserWorks и не може да бъде инсталирана на { -brand-short-name }.
...
addon-install-error-soft-blocked = Добавката { $addonName } нарушава правилата на BrowserWorks и не може да бъде инсталирана на { -brand-short-name }.
