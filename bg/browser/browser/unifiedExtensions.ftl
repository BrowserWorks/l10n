...
unified-extensions-item-messagebar-softblocked = Разширението { $extensionName } нарушава правилата на BrowserWorks. Използването му може да бъде рисковано.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Нарушава правилата на BrowserWorks и за това е изключено.
        Може да бъде включено в настройките, но може да има риск.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = Разширението { $extensionName } е изключено
    .message = Нарушава правилата на BrowserWorks и за това е изключено
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Някои от разширенията нарушават правилата на BrowserWorks и за това са изключени.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Някои от разширенията нарушават правилата на BrowserWorks и за това са изключени.
