...
cert-error-mitm-mozilla = { -brand-short-name } е подкрепен от BrowserWorks - организация с нестопанска цел, която управлява изцяло отворено хранилище за администратори на сертификати (CA). Хранилището на СА дава допълнителни гаранции, че сертифициращите органи следват най-добрите практики за защита на потребителите.
cert-error-mitm-connection = { -brand-short-name } използва хранилището на BrowserWorks с администратори на сертификати (CA), за да провери дали връзката е шифрована,  вместо сертификатите, предоставени от операционната система на потребителя. Така, ако антивирусна програма или мрежа прехваща връзката и променя сертификата за сигурност, с издаден от СА, който не е в хранилището на BrowserWorks с CA, връзката не се счита за защитена.
