...
cert-error-mitm-mozilla = { -brand-short-name } қолдауын көрсететін коммерциялық емес BrowserWorks ұйымы, ол болса, сертификаттау орталықтары сертификаттарының ашық қоймасын басқарады. Бұл қойма сертификаттау орталықтары пайдаланушылар қауіпсіздігін сақтаудың ең жақсы тәсілдерін ұстанатынына көз жеткізуге мүмкін етеді.
cert-error-mitm-connection = Байланыс қауіпсіздігін тексеру үшін, { -brand-short-name } пайдаланушының операциялық жүйесінің құрамындағы қойманы емес, BrowserWorks ұсынған сертификттау орталықтарының сертификаттар қоймасын пайдаланады. Сондықтан, антивирустық бағдарлама немесе желі BrowserWorks СО қоймасында жоқ СО шығарған сертификатты қолданатын байланысты жолда ұстап қалатын болса, байланыс қауіпсіз емес ретінде саналады.
...
fp-certerror-pkix-not-yet-valid-why-dangerous-body = { -brand-short-name } бұл сайтқа сенбейді, себебі берілген сертификат { DATETIME($date, month: "numeric", day: "numeric", year: "numeric") } күні сағат { DATETIME($date, timeStyle: "short") } уақытына дейін жарамсыз сияқты.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
# Variables:
#   $date (Date) - Device's clock date.
fp-certerror-pkix-not-yet-valid-what-can-you-do-body = Сіздің құрылғыңыздың сағаты { DATETIME($date, timeStyle: "short") } { DATETIME($date, month: "numeric", day: "numeric", year: "numeric") } шамасына орнатылған. Бұл дұрыс болса, қауіпсіздік мәселесі сайттың өзінде болуы мүмкін. Бұл дұрыс емес болса, оны құрылғының жүйелік баптауларынан өзгертуге болады.
# This string appears after the following string: "What makes the site look dangerous?" (fp-certerror-why-site-dangerous)
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-certerror-invalid-cert-why-dangerous = { $hostname } иесі оны дұрыс баптамады және қауіпсіз байланысты жасау мүмкін емес.
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
#   $now (Date) - The current datetime, to be formatted as a date
fp-certerror-clock-skew-intro = Компьютеріңіз қазіргі уақытты { DATETIME($now, dateStyle: "medium") } деп санайды, бұл { -brand-short-name } үшін қауіпсіз қосылым орнатуға кедергі келтіреді. <strong>{ $hostname }</strong> торабына өту үшін, жүйе баптауларында компьютер сағатын ағымдағы күнге, уақытқа және уақыт белдеуіне жаңартыңыз да, парақты қайта жүктеңіз.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
# Variables:
#   $now (Date) - The current datetime, to be formatted as a date
fp-certerror-clock-skew-what-can-you-do-body = Жүйе баптауларында компьютер сағатын ағымдағы күнге, уақытқа және уақыт белдеуіне жаңартыңыз да, парақты қайта жүктеңіз. Компьютеріңіз қазіргі уақытты { DATETIME($now, dateStyle: "medium") } деп санайды.
...
cert-error-cert-not-in-name-space = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификат оны шығарған сертификаттың атау шектеулеріне сәйкес келмейді.
cert-error-inadequate-cert-type = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификатты веб-сервер пайдалануына рұқсат етілмеген.
cert-error-path-len-constraint-invalid = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификаттың түбірлік сертификатқа дейінгі жолында аралық сертификаттар тым көп.
cert-error-invalid-key = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификаттың кілті жарамсыз. Шамасы, бұл кілт қауіпсіздікті қамтамасыз ету үшін тым қысқа.
cert-error-unknown-critical-extension = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификатта қолдау көрсетілмейтін маңызды кеңейту бар.
cert-error-extension-value-invalid = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификатта жарамсыз кеңейту бар.
cert-error-untrusted-issuer = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификат бұдан былай сенімді емес сертификаттау орталығы арқылы шығарылған.
cert-error-untrusted-cert = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификат сенімсіз деп белгіленген.
cert-error-invalid-integer-encoding = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификатта бүтін санның кодталуы қате. Жиі кездесетін себептерге теріс сериялық нөмірлер, теріс RSA модульдері және қажеттіліктен ұзын кодтаулар жатады.
cert-error-unsupported-keyalg = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификаттың кілт түріне қолдау көрсетілмейді.
cert-error-issuer-no-longer-trusted = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификатты шығарған сертификаттау орталығы бұдан былай сенімді емес.
cert-error-signature-algorithm-mismatch = { -brand-short-name } бұл сайтқа кіруіңізді блоктады, себебі { $hostname } үшін берілген сертификаттың қолтаңба алгоритмі оның қолтаңба алгоритмі өрісіне сәйкес келмейді.
...
corruptedContentErrorv2-title = Мазмұнның зақымдану қатесі
