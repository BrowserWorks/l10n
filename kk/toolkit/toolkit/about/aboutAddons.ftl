...
discopane-intro3 =
    ...
    Бұл шағын бағдарламаларды көбінесе үшінші тарап әзірлеушілері жасайды. Төменде Waterfox қауіпсіздік,
...
addon-badge-recommended4 =
    .title = Waterfox тек қауіпсіздік және өнімділік стандарттарына сай келетін кеңейтулерді ұсынады
...
recommended-theme-1 = Шабытты сезіп тұрсыз ба? <a data-l10n-name="link">Waterfox Color көмегімен өз темаңызды жасаңыз.</a>
