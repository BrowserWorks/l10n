...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } BrowserWorks саясаттарын бұзады. Оны пайдалану қауіпті болуы мүмкін.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Бұл кеңейту BrowserWorks саясаттарын бұзады және сөндірілді.
        Оны параметрлерде іске қосуға болады, бірақ бұл қауіпті болуы мүмкін.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } сөндірілді
    .message = Бұл кеңейту BrowserWorks саясаттарын бұзады және сөндірілді.
# Variables:
