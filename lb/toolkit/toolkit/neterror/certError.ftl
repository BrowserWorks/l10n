...
cert-error-mitm-mozilla = { -brand-short-name } gëtt vun der net gewënnorientéierter Organisatioun BrowserWorks ënnerstëtzt, déi eng ganz oppen Datebank vun Certificat-Autoritéite (CA) verwalt. Dës CA Datebank hëlleft ze garantéieren datt d'Certificat-Autoritéiten sech un déi bescht Praktiken fir d'Benotzersécherheet halen.
# Variables:
#   $hostname (string) - Hostname of the website with cert error.
