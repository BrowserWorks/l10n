...
plugins-openh264-description = Sto plugin o vegne instalou aotomaticamente da BrowserWorks, in conformitæ co-e specifiche WebRTC, per consentire chiamate con dispositivi che richiedono un codec video H.264. Vixita http://www.openh264.org/ pe amiate o còdice sorgente e descovrî atre cöse in sce l'inplementaçion.
