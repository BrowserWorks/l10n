...
identity-custom-root = 'Ngō sa ri sertifikadô nitāj si nani'in BrowserWorks gini'iāj dàj 'iaj sun koneksiûn nan.
...
identity-description-custom-root2 = Nu nani'in BrowserWorks sa giri sertifikadô nan. Sa ga'nïn si sistemât huin asi sa ga'nïn 'ngō administrador huin.
