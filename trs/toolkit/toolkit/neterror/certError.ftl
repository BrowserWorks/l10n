...
cert-error-mitm-mozilla = { -brand-short-name } ni yi'nïn' BrowserWorks rugûñun'unj rukû man, dadin' huê yi'nïn' nan dugumîn dukua si sin nej sertifikâdo (CA).
cert-error-mitm-connection = { -brand-short-name } arâj sun riña màn sà' sertifikâdo CA 'iaj BrowserWorks guendâ ga hue'ê gache nun', lugâ garasunj nej si sertifikadô si sistemâ operatibô'. Ô' ni, sisi 'ngo sa duguêj yi'ìi asi 'ngo red nani'in sisi hua sertifikadô se si'iaj BrowserWorks CA huin ni, nanai'in sisi 'ngo koneksiûn ahii nahuin man.
