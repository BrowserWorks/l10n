...
mr2022-onboarding-gratitude-subtitle = Mercés d’utilizar { -brand-short-name }, sostengut per la Fondacion BrowserWorks. Amb vòstre sosten, nos esforçam a far venir Internet mai dubèrt, accessible e melhor per tot lo monde.
