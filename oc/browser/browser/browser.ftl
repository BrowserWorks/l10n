...
browser-main-private-window-title =
    { PLATFORM() ->
        [macos] { -brand-full-name } — Navegacion privada
       *[other] { -brand-full-name } navegacion privada
    }
...
urlbar-result-menu-button-feedback = Comentaris
    .title = Dobrir lo menú
urlbar-result-menu-learn-more2 = Ne saber mai
    .accesskey = N
urlbar-result-menu-remove-from-history2 = Tirar de l’istoric
    .accesskey = T
urlbar-result-menu-tip-get-help2 = Obténer d’ajuda
    .accesskey = a
...
clear-search-history =
    .label = Voidar l'istoric de recèrca
    .accesskey = E
...
identity-custom-root = Connexion verificada per un emissor de certificat pas reconegut per BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks reconeis pas aqueste emissor de certificats. Benlèu que foguèt apondut per vòstre sistèma operatiu o per un administrator.
...
urlbar-result-menu-trending-dont-show2 = Mostrar pas las recèrcas popularas
    .accesskey = M
# The result menu labels shown next to trending results.
...
popup-notification-addon-privatebrowsing-checkbox2 =
    .label = Permetre a l’extension de s’executar en fenèstras privadas
    .accesskey = P
