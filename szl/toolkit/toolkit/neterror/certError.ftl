...
cert-error-mitm-mozilla = { -brand-short-name } tworzi ôrganizacyjo BrowserWorks, co zarzōndzo blank ôtwartym magazynym ôrganōw certyfikacyje (CA). Tyn magazyn pōmogo zapewnić przestrzeganie ôd ôrganōw certyfikacyje nojlepszych praktyk dlo bezpieczyństwa używoczōw.
cert-error-mitm-connection = Zamiast certyfikatōw systymowych { -brand-short-name } używo magazynu CA ôrganizacyje BrowserWorks, coby weryfikować bezpieczyństwo połōnczyń. Połōnczynie niyma uznowane za zicher, jak ôprogramowanie antywirusowe abo necowe przechytuje połōnczynie z certyfikatym bezpieczyństwa wystawiōnym ôd ôrganizacyje certyfikowanio, co niy je we magazynie CA ôrganizacyje BrowserWorks.
