...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Załōncz debuggowanie bez USB we Waterfoxie na maszinie z Androidym.
# USB section step by step guide
