...
clear-search-history =
    .label = Pucuj historyjo szukanio
    .accesskey = P
...
identity-custom-root = Połōnczynie je zweryfikowane ôd wystowcy certyfikatu, kerego BrowserWorks niy poznowo.
...
identity-description-custom-root2 = BrowserWorks niy poznowo tego wydowcy certyfikatu. Mōg być przidany z twojigo ôperacyjnego systymu abo ôd administratora.
...
urlbar-searchmode-popup-add-engine = Przidej „{ $engineName }”
    .title = Przidej wyszukowarka „{ $engineName }”
