...
onboarding-gratitude-security-and-privacy-subtitle = Gracias por usar { -brand-short-name }, respaldado por la Fundación BrowserWorks. Con su apoyo, estamos trabajando para que Internet sea más más segura y accesible para todos.
...
create-backup-screen-3-location = ¿Dónde quiere que se guarde la copia de seguridad?
