...
protections-panel-smartblock-desc-label = { -brand-short-name } bloquea el contenido de rastreo mientras se navegue Este sitio a menos que se lo permita.
# Variables
...
smartblock-placeholder-desc = La configuración de { -brand-short-name } bloqueó que esté contenido lo rastree entre sitios o sea usado para publicidades.
...
smartblock-placeholder-content-header = Contenido de embed bloqueado
...
protections-panel-content-blocking-breakage-report-view-description = El bloqueo de ciertos rastreadores puede causar problemas con algunos sitios web. Informar sobre estos problemas ayuda a que { -brand-short-name } sea mejor para todos. Al enviar este informe, se enviará a BrowserWorks una URL e información sobre la configuración de su navegador. <label data-l10n-name="learn-more">Aprender más</label>
