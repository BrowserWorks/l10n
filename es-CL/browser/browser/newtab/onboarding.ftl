...
mr2022-onboarding-gratitude-subtitle = Gracias por usar { -brand-short-name }, respaldado por la fundación BrowserWorks. Con tu ayuda, trabajamos para crear un internet más abierto, accesible y mejor para todos.
...
onboarding-gratitude-security-and-privacy-subtitle = Gracias por usar { -brand-short-name }, respaldado por la fundación BrowserWorks. Con tu ayuda, trabajamos para crear un internet más seguro y más accesible para todos.
...
multiple-backups-info-tile = <strong>Se encontraron varios archivos de copias de seguridad.</strong> Se seleccionó el archivo más reciente. Restaura otros perfiles en <a data-l10n-name="settings-label">Ajustes</a>.
