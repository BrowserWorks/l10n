...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Algunas de tus extensiones han sido desactivadas por violar las políticas de BrowserWorks.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Algunas de tus extensiones han sido desactivadas por violar las políticas de BrowserWorks.
