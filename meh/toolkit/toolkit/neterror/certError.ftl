...
cert-error-mitm-mozilla = { -brand-short-name } vají jiee BrowserWorks, vetiñu ntu ni´i xu´un je kumiji iin nuu chuva´a certificado(CA). Ve´i xiko CA chinei a da ñivɨ sá'á certificación kuntadaja a va´a je kumí ñivɨ ni´i ka̱a̱ ya´a.
cert-error-mitm-connection = { -brand-short-name } ni´i nuu chuva´a BrowserWorks CA kuvi kune´ya conexión íyo vatu, ntu ji da certificados taji ka̱a̱ operativo. Je de iin antivirus a xíín iin red nasɨ nuu iin conexiòn ji certificado taji CA je ntu nchuva´a nuu CA BrowserWorks, conexión nko vatu.
