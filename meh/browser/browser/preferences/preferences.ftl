...
sync-mobile-promo = Xinuun Waterfox <img data-l10n-name="android-icon"/><a data-l10n-name="android-link"> Android</a> a xíín <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link"></a> saa sincronizar ji ka̱a̱ noo´o.
...
sync-engine-addons =
    ...
    .tooltiptext = Ka̱a̱ chunta´an Waterfox escritorio
    .accesskey = K
