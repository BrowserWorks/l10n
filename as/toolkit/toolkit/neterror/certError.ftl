...
cert-error-mitm-mozilla = { -brand-short-name } অলাভকাৰী BrowserWorks দ্বাৰা সমৰ্থিত, যিয়ে সম্পূৰ্ণৰূপে মুক্ত প্ৰমাণপত্ৰ প্ৰাধিকাৰী (CA) ষ্ট'ৰ পৰিচালনা কৰে। CA ষ্ট'ৰে এয়া নিশ্চিত কৰাত সহায় কৰে যে প্ৰমাণপত্ৰ প্ৰাধিকাৰীসকলে ব্যৱহাৰকাৰীৰ নিৰাপত্তাৰ বাবে সৰ্বোত্তম অনুশীলন মানি চলে।
cert-error-mitm-connection = কোনো সংযোগ নিৰাপদ বুলি সত্যাপন কৰিবলৈ { -brand-short-name }-এ ব্যৱহাৰকাৰীৰ অ'পাৰেটিং ছিষ্টেম দ্বাৰা যোগান ধৰা প্ৰমাণপত্ৰ ব্যৱহাৰ কৰাৰ সলনি BrowserWorks CA ষ্ট'ৰ ব্যৱহাৰ কৰে। গতিকে, যদি কোনো এণ্টিভাইৰাছ প্ৰ'গ্ৰাম বা নেটৱৰ্কে BrowserWorks CA ষ্ট'ৰত নথকা কোনো CA দ্বাৰা জাৰি কৰা নিৰাপত্তা প্ৰমাণপত্ৰৰে কোনো সংযোগ প্ৰতিৰোধ কৰে, তেন্তে সেই সংযোগটো অসুৰক্ষিত বুলি বিবেচনা কৰা হয়।
