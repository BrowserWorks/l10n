...
clear-search-history =
    .label = সন্ধানৰ ইতিহাস পৰিষ্কাৰ কৰক
    .accesskey = H
...
identity-custom-root = এনে এক প্ৰমাণপত্ৰ জাৰীকৰ্তাৰ দ্বাৰা সংযোগ প্ৰমাণিত কৰা হৈছে যাক BrowserWorks-ই চিনি নাপায়।
...
identity-description-custom-root2 = BrowserWorks-ই এই প্ৰমাণপত্ৰ জাৰীকৰ্তাক চিনি নাপায়। এইটো আপোনাৰ অপাৰেটিং ছিষ্টেমৰ পৰা নাইবা এগৰাকী কৰ্তৃপক্ষৰ দ্বাৰা যোগ কৰা হ'ব পাৰে।
...
identity-description-passive-loaded-insecure2 = এই ৱেবছাইটত এনে সমল আছে যি সুৰক্ষিত নহয় (যেনে ছবি)।
...
urlbar-searchmode-popup-add-engine = “{ $engineName }” যোগ কৰক
    .title = “{ $engineName }” ছাৰ্চ ইঞ্জিন যোগ কৰক
...
reader-view-enter-button =
    .aria-label = ৰিডাৰ ভিউত প্ৰৱেশ কৰক
