...
default-bookmarks-firefox-customize = Waterfox কাষ্টমাইজ কৰক
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = জড়িত হওক
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = আমাৰ বিষয়ে
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly-ৰ সমলবোৰ
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly-ৰ ব্লগ
