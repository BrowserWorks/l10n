...
clear-search-history =
    .label = Neteja l'historial de cerques
    .accesskey = c
...
identity-custom-root = Connexió verificada per un emissor de certificats que no és reconegut per BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks no reconeix este emissor de certificats. És possible que l'haja afegit el vostre sistema operatiu o un administrador.
...
urlbar-searchmode-popup-add-engine = Afig «{ $engineName }»
    .title = Afig el motor de cerca «{ $engineName }»
