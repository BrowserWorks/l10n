...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktiviraj USB uklanjanje grešaka u Waterfoxu na Android uređaju.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ova verzija Waterfoxa ne može uklanjati greške programa Waterfox za Android (68). Preporučujemo instaliranje Waterfoxa za Android Nightly na mobitel radi testiranja. <a>Više detalja</a>
...
about-debugging-browser-version-too-recent = Povezani preglednik je noviji { $runtimeVersion }, ID gradnje { $runtimeID } od tvog { -brand-shorter-name(case: "gen") } ({ $localVersion }, ID gradnje { $localID }). Ovo je nepodržana postava i programerski alati možda neće raditi. Aktualiziraj Waterfox. <a>Ispravljanje grešaka</a>
