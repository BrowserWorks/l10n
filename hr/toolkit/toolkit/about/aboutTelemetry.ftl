...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Waterfoxova dokumentacija podataka</a> sadrži upute za rad s našim podatkovnim alatima.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Klijentska dokumentacija Waterfox telemetrije</a> uključuje definicije za koncepte, API dokumentaciju i reference podataka.
