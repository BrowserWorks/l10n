...
# and kept in English.
-firefox-suggest-brand-name = Waterfoxovi prijedlozi
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Početna Waterfox stranica
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Waterfox pogled
