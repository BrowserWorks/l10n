...
protections-panel-content-blocking-breakage-report-view-description = Blokiranje određenih programa za praćenje može uzrokovati probleme s nekim web-stranicama. Prijavljivanjem ovih problema pomoći ćeš unaprijediti { -brand-short-name } za sve korisnike. Kada pošalješ ovu prijavu, BrowserWorks će primiti poruku s URL podacima i informacije o postavkama preglednika. <label data-l10n-name="learn-more">Saznaj više</label>
