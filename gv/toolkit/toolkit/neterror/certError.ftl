...
cert-error-mitm-mozilla = Ta { -brand-short-name } geddyn cooney woish BrowserWorks as t'ad reirey tasht lught reill teishtyn (LRT).  Ta'n tasht TLRT cooney dy hickyraghey dy vel lughtyn reill lhiantyn rish cliaghtaghyn share bentyn rish sauçhys ymmydeyr.
cert-error-mitm-connection = Ta { -brand-short-name } gymmydey yn tasht LRT ec BrowserWorks dy yannoo shickyr dy vel kiangley sauçhey, ayns ynnyd jeh teishtyn voish coarys obbree yn ymmydeyr.  Myr shen, my vees claare noi veerysyn ny moggyl lhiettal kiangley lesh teisht sauçhys currit magh liorish LRT nagh vel ayns tasht LRT Vozilla, bee briwnys jeant nagh vel yn chiangley sauçhey.
