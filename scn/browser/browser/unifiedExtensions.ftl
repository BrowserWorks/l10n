...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Stu stinneriu va contra ê pulìtichi di BrowserWorks e fu sdisabbilitatu.
        U po’ abbilitari arrè nnê mpustazzioni, ma po’ èssiri un rìsicu.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } sdisabbilitatu
    .message = Stu stinneriu va contra ê pulìtichi di BrowserWorks e fu sdisabbilitatu.
