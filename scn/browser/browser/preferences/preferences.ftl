...
sync-mobile-promo = Scàrrica Waterfox pi <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> pi sincrunizzàriti cû to dispusitivu mòbbili.
...
sync-engine-addons =
    .label = Juncitini
    .tooltiptext = Stinneri e temi pi Waterfox nnâ virsiuni scagnu
    .accesskey = J
