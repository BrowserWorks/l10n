...
cert-error-mitm-mozilla = { -brand-short-name } è sustinutu di BrowserWorks, n’urganizzazziuni senza scopu di lucru chi amministra na ricota cumplitamenti lìbbira di auturità di cirtificazziuni (CA). Sta ricota ajuta a èssiri sicuri chi l’auturità cirtificatrici sicùtanu i megghiu pràtichi pâ sicurizza di l’utenti.
cert-error-mitm-connection = { -brand-short-name } usa a ricota di CA di BrowserWorks pi virificari chi na cunnissiuni è sicura, mmeci dî cirtificati dû sistema upirativu di l’utenti. Nna sta manera, si un prugramma antivirus o na riti ntircetta na cunnissiuni c’un cirtificatu di sicurizza chi nun è nnâ ricota CA di BrowserWorks, a cunnissiuni nun veni cunzidirata sicura.
