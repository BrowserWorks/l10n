...
default-bookmarks-firefox-customize = خصّص Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = كيفية المساهمة
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = معلومات عنا
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = موارد Waterfox الليلي
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = مدونة Waterfox الليلي
