...
addon-install-error-hard-blocked = { $addonName } a za a-enep da reolennoù BrowserWorks ha n'hall ket bezañ staliet war { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } a za a-enep da reolennoù BrowserWorks ha n'hall ket bezañ staliet war { -brand-short-name }.
