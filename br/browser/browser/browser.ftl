...
urlbar-result-menu-button-feedback = Evezhiadennoù
    .title = Digeriñ al lañser
urlbar-result-menu-learn-more2 = Gouzout hiroc’h
    .accesskey = G
urlbar-result-menu-remove-from-history2 = Dilemel eus ar roll-istor
    .accesskey = i
urlbar-result-menu-tip-get-help2 = Skoazell
    .accesskey = S
urlbar-result-menu-manage-firefox-suggest2 = Merañ { -firefox-suggest-brand-name }
    .accesskey = M
...
identity-custom-root = Gwiriet eo bet ar c'hennask hag ur pourchaser testenioù n'eo ket adanavezet gant BrowserWorks.
...
identity-description-custom-root2 = Ne adanavez ket BrowserWorks pourchaser an testeni-mañ. Marteze eo bet ouzhpennet gant ho reizhiad korvoiñ pe gant un ardoer.
