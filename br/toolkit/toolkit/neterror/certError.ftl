...
cert-error-mitm-mozilla = Gant ar gevredigezh hep pal kenwerzhel BrowserWorks eo harpet { -brand-short-name }, a ver ur stal aotrouniezh testenioù (CA) digor penn-da-benn. Ar stal CA a sikour evit bezañ sur e vez heuliet an hentennoù erbedet gant an aotrouniezhoù testeniañ evit diogelroez an arveriaded.
cert-error-mitm-connection = { -brand-short-name } a implij stal CA BrowserWorks evit gwiriekaat eo diogel ur c’hennask, kentoc’h eget an testenioù roet gant reizhiad korvoiñ an arveriad. Dre se, ma vez daspaket ur c’hennask gant un enepvirus pe ur rouedad gant un testeni diogelroez pourchaset gant ur CA n’eo ket e stal CA BrowserWorks eo gwelet evel diziogel ar c’hennask.
