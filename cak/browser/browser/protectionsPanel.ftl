...
protections-panel-content-blocking-breakage-report-view-description = Toq yeq'at jujun taq ojqanela' nitikïr nuya' k'ayewal pa jujun ajk'amaya'l ruxaq. Toq naya' kitzijol k'ayewal, yato'on chi ri { -brand-short-name } ütz nub'än chi qawäch qonojel. Toq natäq re rutzijol, xtitaq pa jun URL chuqa' ri etamab'äl chi rij ri runuk'ulem ri awokik'amaya'l chi re ri BrowserWorks. <label data-l10n-name="learn-more">Tetamäx ch'aqa' chik</label>
