...
urlbar-result-menu-button-feedback = Rutzijol
    .title = Tijaq k'utsamaj
urlbar-result-menu-learn-more2 = Tetamäx ch'aqa' chik
    .accesskey = t
urlbar-result-menu-remove-from-history2 = Tiyuj pa natab'äl
    .accesskey = y
...
clear-search-history =
    .label = Tijosq'ïx rupam ri runatab'al kanoxïk
    .accesskey = L
...
identity-custom-root = Xjikib'äx ri okem ruma ya'öl iqitzijib'äl, ri man retaman ta ruwäch ri BrowserWorks.
...
identity-description-custom-root2 = Ri BrowserWorks man retaman ta ruwäch ri ruya'öl iqitzijib'äl BrowserWorks. Rik'in jub'a' xtz'aqatisäx pa jun samajel q'inoj o ruma jun nuk'samajel.
