...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } încalcă politicile BrowserWorks. Utilizarea poate fi riscantă.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } dezactivată
    .message =
        Extensia încalcă politicile BrowserWorks și a fost dezactivată.
        O poți activa în setări, dar poate fi riscant.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } dezactivată
    .message = Extensia încalcă politicile BrowserWorks și a fost dezactivată.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Unele extensii au fost dezactivate pentru că încalcă politicile BrowserWorks.
        Le poți activa în setări, dar poate fi riscant.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Unele extensii au fost dezactivate pentru că încalcă politicile BrowserWorks.
