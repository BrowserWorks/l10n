...
addon-install-error-hard-blocked = { $addonName } încalcă politicile BrowserWorks și nu poate fi instalat pe { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } încalcă politicile BrowserWorks și nu poate fi instalat pe { -brand-short-name }.
