...
quickactions-editpdf = Deschide editorul PDF
...
identity-custom-root = Conexiune verificată de un emițător de certificate nerecunoscut de BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks nu recunoaște acest emițător de certificate. Este posibil să fi fost adăugat de sistemul tău de operare sau de un administrator.
...
urlbar-result-explanation-last-visited-relative = Ultima ta vizită a fost { $date }
...
urlbar-result-explanation-last-visited-days =
    { $daysAgo ->
        [one] Ultima ta vizită a fost acum { $daysAgo } zi
        [few] Ultima ta vizită a fost acum { $daysAgo } zile
       *[other] Ultima ta vizită a fost acum { $daysAgo } de zile
    }
...
urlbar-result-explanation-last-visited-weeks =
    { $weeksAgo ->
        [one] Ultima ta vizită a fost acum { $weeksAgo } săptămână
        [few] Ultima ta vizită a fost acum { $weeksAgo } săptămâni
       *[other] Ultima ta vizită a fost acum { $weeksAgo } de săptămâni
    }
...
urlbar-result-explanation-last-visited-months =
    { $monthsAgo ->
        [one] Ultima ta vizită a fost acum { $monthsAgo } lună
        [few] Ultima ta vizită a fost acum { $monthsAgo } luni
       *[other] Ultima ta vizită a fost acum { $monthsAgo } de luni
    }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute = Ultima ta vizită a fost pe { $date }
...
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-bookmarked = Marcat pe { $date }
# This explanation is used when the last-visited date is formatted as one of the
# following relative dates: "yesterday", "today"
# Variables:
#   $date (string) - A localized relative date string
...
urlbar-result-explanation-last-visited-days-2 =
    { $daysAgo ->
        [one] Ultima vizită a fost acum { $daysAgo } zi
        [few] Ultima vizită a fost acum { $daysAgo } zile
       *[other] Ultima vizită a fost acum { $daysAgo } de zile
    }
# This explanation is used when the last-visited date is a small number of weeks
# in the past.
# Variables:
...
urlbar-result-explanation-last-visited-weeks-2 =
    { $weeksAgo ->
        [one] Ultima vizită a fost acum { $weeksAgo } săptămână
        [few] Ultima vizită a fost acum { $weeksAgo } săptămâni
       *[other] Ultima vizită a fost acum { $weeksAgo } de săptămâni
    }
# This explanation is used when the last-visited date is a small number of
# months in the past.
# Variables:
...
urlbar-result-explanation-last-visited-months-2 =
    { $monthsAgo ->
        [one] Ultima vizită a fost acum { $monthsAgo } lună
        [few] Ultima vizită a fost acum { $monthsAgo } luni
       *[other] Ultima vizită a fost acum { $monthsAgo } de luni
    }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute-2 = Ultima vizită { $date }
...
firefox-relay-offer-legal-notice = Dând clic pe „Folosește masca de e-mail”, ești de acord cu <label data-l10n-name="tos-url">Condițiile de utilizare a serviciilor</label> și <label data-l10n-name="privacy-url">Notificarea privind confidențialitatea</label>.
