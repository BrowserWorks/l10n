...
about-debugging-browser-version-too-old-fennec = Această versiune de Waterfox nu poate depana Waterfox pentru Android (68). Recomandăm instalarea pentru testare pe telefon a versiunii Nightly de Waterfox pentru Android. <a>Mai multe detalii</a>
