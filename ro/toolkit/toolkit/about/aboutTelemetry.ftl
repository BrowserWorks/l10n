...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Documentația de date Waterfox</a> conține ghiduri despre cum să lucrezi cu instrumentele noastre de date.
