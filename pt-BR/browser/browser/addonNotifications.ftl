...
addon-mlmodel-removal-body = Se você usar os recursos ou extensões que usam este modelo, ele será novamente adicionado.
# Variables:
...
addon-install-error-hard-blocked = { $addonName } viola diretrizes da BrowserWorks, não pode ser instalado no { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } viola diretrizes da BrowserWorks, não pode ser instalado no { -brand-short-name }.
