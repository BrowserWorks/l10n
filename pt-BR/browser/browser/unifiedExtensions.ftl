...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } viola diretrizes da BrowserWorks. Usar pode ser arriscado.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } desativado
    .message =
        Esta extensão viola diretrizes da BrowserWorks e foi desativada.
        Você tem opção de ativar nas configurações, mas pode ser arriscado.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } desativado
    .message = Esta extensão viola diretrizes da BrowserWorks e foi desativada.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Algumas extensões instaladas foram desativadas por violar diretrizes da BrowserWorks.
        Você pode habilitar nas configurações, mas pode ser arriscado.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Algumas extensões instaladas foram desativadas por violar diretrizes da BrowserWorks.
