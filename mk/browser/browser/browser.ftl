...
clear-search-history =
    .label = Исчисти ја историјата од пребарувањата
    .accesskey = И
...
identity-custom-root = Врската е потврдена од издавач на сертификат што не е препознаен од BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks не го препознава издавачот на овој сертификат. Можеби е додаден од вашиот оперативен систем или од администратор.
...
urlbar-searchmode-popup-add-engine = Додадете „{ $engineName }“
    .title = Додајте пребарувач „{ $engineName }“
...
picture-in-picture-move-toggle-right =
    .label = Премести го копчето за слика-во-слика на десната страна
    .accesskey = р
