...
cert-error-mitm-mozilla = { -brand-short-name } е поддржан од непрофитната BrowserWorks, која раководи целосно отворена продавница за сертификати (CA). Продавницата CA помага да се осигура дека властите за сертификати ги следат најдобрите практики за безбедност на корисниците.
cert-error-mitm-connection = { -brand-short-name } ја користи продавницата BrowserWorks CA за да потврди дека врската е безбедна, наместо сертификатите дадени од оперативниот систем на корисникот. Значи, ако антивирусна програма или мрежа пресретнува врска со безбедносен сертификат издаден од CA што не е во продавницата BrowserWorks CA, врската се смета за небезбедна.
