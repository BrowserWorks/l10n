...
plugins-openh264-description = Овој приклучок е автоматски инсталиран од BrowserWorks за да се усогласи со спецификацијата WebRTC и да овозможи WebRTC повици со уреди на кои им е потребен видео кодекот H.264. Посетете ја страницата https://www.openh264.org/ за да го видите изворниот код на кодекот и да дознаете повеќе за имплементацијата.
