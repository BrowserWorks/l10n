...
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox-ի հեռուսաչափության սպասառուի փաստաթղթավորումը</a> ներառում է հասկացուցումների սահմանումներ , API փաստաթղթավորում և տվյալների հղումներ։
