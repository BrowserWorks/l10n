...
cert-error-mitm-mozilla = { -brand-short-name } -ն ապահովված է շահույթ չհետապնդող BrowserWorks- ի կողմից, որը կառավարում է լիովին բաց հավաստագրման իրավասության (CA) խանութ: CA խանութն օգնում է ապահովել, որ հավաստագրման մարմինները հետևում են օգտագործողների անվտանգության լավագույն փորձին:
cert-error-mitm-connection = { -brand-short-name } - ն օգտագործում է BrowserWorks CA խանութը `հաստատելու, որ կապն ապահով է, այլ ոչ թե օգտագործողի գործառնական համակարգի կողմից տրամադրված վկայագրերի: Այսպիսով, եթե հակավիրուսային ծրագիրը կամ ցանցը ընդհատում են կապը անվտանգության BrowserWorks- ի կողմից, որը BrowserWorks CA խանութում չէ, կապը համարվում է անապահով:
