...
default-bookmarks-firefox-customize = Անհատականացնել Waterfox-ը
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ներգրավվել
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Մեր մասին
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly ռեսուրսներ
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly բլոգ
