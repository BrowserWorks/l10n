...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName }-ը խախտում է BrowserWorks-ի քաղաքականությունը։ Դրա օգտագործումը կարող է վտանգավոր լինել։
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName }-ն անջատված է
    .message =
        Այս ընդլայնումը խախտում է BrowserWorks-ի քաղաքականությունները և անջատված է:
        Կարող եք այն միացնել կարգավորումներում, բայց դա վտանգավոր է:
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName }-ն անջատված է
    .message = Այս ընդլայնումը խախտում է BrowserWorks-ի քաղաքականությունները և անջատվել է:
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Ձեր որոշ ընդլայնումներ անջատվել են BrowserWorks-ի քաղաքականությունները խախտելու համար:
        Կարող եք այն միացնել կարգավորումներում, բայց դա վտանգավոր է:
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Ձեր որոշ ընդլայնումներ անջատվել են, քանի որ խախտել են BrowserWorks-ի քաղաքականությունները:
