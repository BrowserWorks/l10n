...
addon-install-error-hard-blocked = { $addonName }-ը խախտում է BrowserWorks-ի քաղաքականությունը և չի կարող տեղադրվել { -brand-short-name }-ում։
...
addon-install-error-soft-blocked = { $addonName }-ը խախտում է BrowserWorks-ի քաղաքականությունը և չի կարող տեղադրվել { -brand-short-name }-ում։
