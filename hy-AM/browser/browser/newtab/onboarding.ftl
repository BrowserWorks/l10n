...
mr2022-onboarding-gratitude-subtitle = Շնորհակալություն { -brand-short-name }-ը օգտագործելու համար, BrowserWorks-ի կողմից: Ձեր աջակցությամբ մենք աշխատում ենք համացանցը դարձնել ավելի բաց, մատչելի և լավ բոլորի համար:
...
onboarding-gratitude-security-and-privacy-subtitle = Շնորհակալություն ենք հայտնում BrowserWorks-ի կողմից աջակցվող { -brand-short-name }-ն օգտագործելու համար։ Ձեր աջակցությամբ մենք աշխատում ենք ինտերնետը բոլորի համար ավելի անվտանգ և հասանելի դարձնելու ուղղությամբ։
...
tab-groups-onboarding-feature-callout-title = Փորձեք ներդիրների խմբերը՝ ավելի քիչ խառնաշփոթ, ավելի շատ կենտրոնացում
