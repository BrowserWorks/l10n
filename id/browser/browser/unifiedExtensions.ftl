...
unified-extensions-item-messagebar-softblocked = { $extensionName } melanggar kebijakan BrowserWorks. Menggunakannya mungkin berisiko.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Ekstensi ini melanggar kebijakan BrowserWorks dan telah dinonaktifkan.
        Anda dapat mengaktifkannya di pengaturan, tetapi ini berisiko bagi Anda.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } dinonaktifkan
    .message = Ekstensi ini melanggar kebijakan BrowserWorks dan telah dinonaktifkan.
# Variables:
#   $extensionsCount (Number) - Number of extensions disabled through both soft and hard-blocks (always going to be greater than 1)
unified-extensions-mb-blocklist-warning-multiple =
    .heading = { $extensionsCount } ekstensi dinonaktifkan
    .message =
        Beberapa ekstensi telah dinonaktifkan karena melanggar kebijakan BrowserWorks.
        Anda dapat mengaktifkannya di pengaturan, tetapi ini berisiko bagi Anda.
# Variables:
#   $extensionsCount (Number) - Number of extensions disabled through hard-blocks.
unified-extensions-mb-blocklist-error-multiple =
    .heading = { $extensionsCount } ekstensi dinonaktifkan
    .message = Beberapa ekstensi telah dinonaktifkan karena melanggar kebijakan BrowserWorks.
