...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Omogućite USB otklanjanje grešaka u Waterfoxu na Android uređaju.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ova verzija Waterfoxa ne može otklanjati greške u Waterfoxu za Android (68). Preporučujemo da instalirate Waterfox za Android Nightly na svoj telefon radi testiranja. <a>Više detalja</a>
...
about-debugging-browser-version-too-recent = Povezani preglednik je noviji ({ $runtimeVersion }, buildID { $runtimeID }) od vašeg { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Ovo je nepodržana postavka i može uzrokovati neuspjeh DevToolsa. Molimo vas da ažurirate Waterfox. <a>Rješavanje problema</a>
