...
identity-custom-root = Veza je verifikovana od strane izdavača certifikata kojeg BrowserWorks ne prepoznaje.
...
identity-description-custom-root2 = BrowserWorks ne prepoznaje ovog izdavaoca certifikata. Možda je dodat iz vašeg operativnog sistema ili od strane administratora.
