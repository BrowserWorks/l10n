...
addon-install-error-hard-blocked = { $addonName } krši BrowserWorks pravila i ne može se instalirati na { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } krši BrowserWorks pravila i ne može se instalirati na { -brand-short-name }.
