...
cert-error-mitm-mozilla = { -brand-short-name } podupire neprofitna organizacija BrowserWorks, koja upravlja potpuno otvorenim skladištem za certifikacijska tijela (CA). CA skladište osigurava, da se certifikacijska tijela pridržavaju najboljih sigurnosnih praksi.
cert-error-mitm-connection = { -brand-short-name } koristi BrowserWorks CA skladište kako bi se provjerila sigurnost veze, a ne koristi certifikate koje je isporučio operacijski sistem korisnika. Dakle, ako antivirusni program ili mreža presreću vezu sa sigurnosnim certifikatom kojeg je izdao CA, a koji nije u BrowserWorks CA skladištu, veza se smatra nesigurnom.
