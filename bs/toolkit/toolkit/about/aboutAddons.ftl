...
addon-badge-recommended4 =
    .title = Waterfox preporučuje samo ekstenzije koje ispunjavaju standarde sigurnosti i performansi
...
recommended-theme-1 = Osjećate se kreativno? <a data-l10n-name="link">Napravite vlastitu temu uz Waterfox Color.</a>
