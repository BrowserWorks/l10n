...
mr2022-onboarding-gratitude-subtitle = Gràcies per utilitzar el { -brand-short-name }, amb el suport de la Fundació BrowserWorks. Amb el vostre suport, treballem per fer que Internet sigui més oberta, accessible i millor per a tothom.
...
onboarding-gratitude-security-and-privacy-subtitle = Gràcies per utilitzar el { -brand-short-name }, amb el suport de la Fundació BrowserWorks. Amb el vostre suport, treballem per fer que Internet sigui més segura i accessible per a tothom.
