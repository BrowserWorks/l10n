...
addon-install-error-hard-blocked = { $addonName } infringeix les polítiques de BrowserWorks i no es pot instal·lar al { -brand-short-name }.
addon-install-error-soft-blocked2 = { $addonName } està restringit i no es pot instal·lar al { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } infringeix les polítiques de BrowserWorks i no es pot instal·lar al { -brand-short-name }.
