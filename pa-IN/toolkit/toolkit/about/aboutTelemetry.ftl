...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Waterfox ਡਾਟਾ ਦਸਤਾਵੇਜ਼ (ਅੰਗਰੇਜ਼ੀ)</a> ਵਿੱਚ ਗਾਈਡਾਂ ਹਨ, ਜੋ ਕਿ ਸਾਡੇ ਡਾਟਾ ਟੂਲ ਨਾਲ ਕੰਮ ਕਰਨ ਬਾਰੇ ਜਾਣਕਾਰੀ ਦਿੰਦੀਆਂ ਹਨ।
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox ਟੈਲੀਮੈਂਟਰੀ ਕਲਾਈਂਟ ਦਸਤਾਵੇਜ਼</a> ਵਿੱਚ ਸੰਕਲਪ ਦੀਆਂ ਪਰਿਭਾਸ਼ਾਵਾਂ, API ਦਸਤਾਵੇਜ਼ ਅਤੇ ਡਾਟਾ ਹਵਾਲੇ ਮੌਜੂਦ ਹਨ।
