...
default-bookmarks-firefox-customize = Waterfox ਪਸੰਦੀਦਾ ਬਣਾਓ
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = ਸਾਥ ਦਿਓ
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = ਸਾਡੇ ਬਾਰੇ
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly ਸਰੋਤ
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly ਬਲੌਗ
