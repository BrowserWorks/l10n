...
cert-error-mitm-mozilla = { -brand-short-name }ଗୁଡ଼ିକ ଅଣଲାଭକାରୀ BrowserWorks ଦ୍ବାରା ସମର୍ଥିତ । ଏହି ସଂଗଠନ ଏକ ସଂପୂର୍ଣ୍ଣ ଖୋଲା ପ୍ରମାଣପତ୍ର ଅଧିକାରୀ (CA) ଷ୍ଟୋର ପରିଚାଳନା କରିଥାଏ । CA ଷ୍ଟୋର ପ୍ରମାଣପତ୍ର ଅଧିକାରୀ ବ୍ୟବହାରକାରୀମାନେ ସୁରକ୍ଷା ପାଇଁ ଶ୍ରେଷ୍ଠ ପ୍ରୟାସ ପାଳନ କରିବାରେ ସାହାଯ୍ୟ କରିଥାଏ ।
cert-error-mitm-connection = ବ୍ୟବହାରକାରୀଙ୍କ ଅପରେଟିଙ୍ଗ ସିଷ୍ଟମ ଦେୟ ପ୍ରମାଣପତ୍ର ଅପେକ୍ଷା { -brand-short-name } BrowserWorks ର ସିଏ ଭଣ୍ଡାର ଉପଯୋଗ କରି କନେକ୍ସନଟି ସୁରକ୍ଷିତ କି ନୁହେଁ ଯାଞ୍ଚ କରିଥାଏ । ଯାହାଦ୍ଵାରା ଯଦି କୌଣସି ଆଣ୍ଟିଭାଇରସ କିମ୍ବା ଏକ ନେଟୱର୍କ ସିଏ ଦ୍ୱାରା ପ୍ରଦତ୍ତ ପ୍ରମାଣପତ୍ର BrowserWorks ଭଣ୍ଡାରରେ ନାହିଁ ବୋଲି ଦେଖେ ତେବେ ଏହାକୁ ଅସୁରକ୍ଷିତ ବୋଲି ଧରାଯାଇଥାଏ ।
