...
cert-error-mitm-mozilla = { -brand-short-name } podtur nakomerciala organizaceja BrowserWorks, kurai ir sova piļneibā atklōta sertifikacejis centru izdūtu sertifikatu globōtuve. Globōtuve paleidz porzalīcynōt, ka sertifikacejis centri ryupejās par lītōtōju datim pec lobōkōs prakses.
cert-error-mitm-connection = { -brand-short-name } izmontoj navys lītōtōja OS sertifikatus, bet BrowserWorks CA store kab porbaudeitu, ci savīnojums ir drūšs. Sekojuši, ja antivirusa programma voi teikls portver BrowserWorks CA store sertifikatu, tad savīnojums teik atzeits par nadrūšu.
...
cert-error-ssl-connection-error = Nūtykusi klaida sasavīnojūtīs ar { $hostname }. { $errorMessage }
# Variables:
#   $hostname (string) - Hostname of the website with cert error.
