...
sync-mobile-promo = Lejupīluodeit Waterfox <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> voi <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> to sync with your mobile device.
...
sync-engine-addons =
    ...
    .tooltiptext = Paplašinojumi un tēmas Waterfox datora versejai
    .accesskey = a
