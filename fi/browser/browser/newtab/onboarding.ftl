...
onboarding-animation-pause-button =
    .aria-label = Keskeytä animaatio
onboarding-animation-play-button =
    .aria-label = Toista animaatio
...
mr2022-onboarding-gratitude-subtitle = Kiitos, että käytit { -brand-short-name }ia, jota BrowserWorks tukee. Tukesi avulla pyrimme tekemään internetistä entistä avoimemman, saavutettavamman ja paremman kaikille.
...
onboarding-gratitude-security-and-privacy-subtitle = Kiitos, että käytät BrowserWorks-säätiön tukemaa { -brand-short-name }ia. Tukesi avulla pyrimme tekemään Internetistä entistä turvallisemman ja helpommin saavutettavan kaikille.
