...
urlbar-result-menu-button-feedback = Palaute
    .title = Avaa valikko
urlbar-result-menu-learn-more2 = Lue lisää
    .accesskey = L
urlbar-result-menu-remove-from-history2 = Poista historiasta
    .accesskey = R
urlbar-result-menu-tip-get-help2 = Tuki
    .accesskey = T
urlbar-result-menu-dismiss-suggestion2 = Hylkää tämä ehdotus
    .accesskey = ä
urlbar-result-menu-manage-firefox-suggest2 = Hallitse { -firefox-suggest-brand-name }ia
    .accesskey = H
...
identity-custom-root = Yhteys on suojattu varmenteella, jonka myöntäjää BrowserWorks ei tunnista.
...
identity-description-custom-root2 = BrowserWorks ei tunnista tämän varmenteen myöntäjää. Se on voitu lisätä käyttöjärjestelmästä tai järjestelmänvalvojan toimesta.
...
urlbar-result-action-move-tab-to-split-view = Siirrä välilehti jaettuun näkymään
...
urlbar-result-addons-subtitle = { -brand-product-name }-laajennus
...
urlbar-result-suggestion-recommended = Suositeltu
...
urlbar-result-explanation-last-visited-relative = Kävit viimeksi { $date }
...
urlbar-result-explanation-last-visited-days =
    { $daysAgo ->
        [one] Kävit viimeksi { $daysAgo } päivä sitten
       *[other] Kävit viimeksi { $daysAgo } päivää sitten
    }
...
urlbar-result-explanation-last-visited-weeks =
    { $weeksAgo ->
        [one] Kävit viimeksi { $weeksAgo } viikko sitten
       *[other] Kävit viimeksi { $weeksAgo } viikkoa sitten
    }
...
urlbar-result-explanation-last-visited-months =
    { $monthsAgo ->
        [one] Kävit viimeksi { $monthsAgo } kuukausi sitten
       *[other] Kävit viimeksi { $monthsAgo } kuukautta sitten
    }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute = Kävit viimeksi { $date }
...
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-bookmarked = Lisätty kirjanmerkkeihin { $date }
# This explanation is used when the last-visited date is formatted as one of the
# following relative dates: "yesterday", "today"
# Variables:
#   $date (string) - A localized relative date string
...
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute-2 = Käyty viimeksi { $date }
...
urlbar-result-realtime-opt-in-dismiss-all2 = Älä näytä näitä ehdotuksia
# This string is shown in the result menu.
urlbar-result-menu-dont-show-market2 = Älä näytä osakemarkkinaehdotuksia
...
urlbar-result-menu-trending-dont-show2 = Älä näytä suositujja hakuja
    .accesskey = Ä
...
qrcode-panel-error =
    .message = QR-koodin luominen epäonnistui. Yritä uudelleen.
qrcode-copy-button =
    .label = Kopioi
qrcode-copy-success =
    .message = QR-koodi kopioitu leikepöydälle.
qrcode-copy-error =
    .message = QR-koodin kopiointi epäonnistui.
qrcode-save-button =
    .label = Tallenna
qrcode-save-success =
    .message = QR-koodi tallennettu.
qrcode-save-error =
    .message = QR-koodin tallennus epäonnistui.
qrcode-save-title = Tallenna QR-koodi
qrcode-save-filter-png = PNG-kuva
qrcode-save-filename = qrkoodi.png
qrcode-window-title = QR-koodi
qrcode-dialog-title = QR-koodi
qrcode-image =
    .aria-label = QR-koodi
qrcode-close-button =
    .aria-label = Sulje
