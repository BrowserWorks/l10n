...
addon-install-error-hard-blocked = { $addonName } rikkoo BrowserWorksn käytäntöjä, eikä sitä voida asentaa { -brand-short-name }iin.
...
addon-install-error-soft-blocked = { $addonName } rikkoo BrowserWorksn käytäntöjä, eikä sitä voida asentaa { -brand-short-name }iin.
