...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Denne udvidelse overtræder BrowserWorkss politikker og er blevet deaktiveret.
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Nogen af dine udvidelser er blevet deaktiveret, fordi de overtræder BrowserWorkss politikker.
