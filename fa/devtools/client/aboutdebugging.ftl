...
about-debugging-browser-version-too-old-fennec = این نگارش از Waterfox نمی‌تواند Waterfox اندروید (۶۸) را اشکال‌زدایی کند. پیشنهاد می‌کنیم که Waterfox اندروید شبانه را روی تلفن همراه‌تان برای آزمایش نصب کنید.<a>جزئیات بیش‌تر</a>
