...
default-bookmarks-firefox-customize = سفارشی‌سازی Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = مشارکت کنید
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = دربارهٔ ما
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = منابع Waterfox شبانه
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = وب‌نوشت Waterfox شبانه
