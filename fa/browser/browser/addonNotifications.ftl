...
addon-install-error-hard-blocked = { $addonName } قوانین BrowserWorks را نقض می‌کند و نمی‌تواند روی { -brand-short-name } نصب شود.
addon-install-error-blocklisted = امکان نصب { $addonName } به دلیل ریسک بالای ایجاد مشکلات پایداری و امنیتی توسط آن وجود ندارد.
addon-install-error-soft-blocked = { $addonName } قوانین BrowserWorks را نقض می‌کند و نمی‌تواند روی { -brand-short-name } نصب شود.
