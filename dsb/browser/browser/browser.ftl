...
urlbar-serial-notification-anchor =
    .tooltiptext = Serijowy wobceŕk wócyniś
...
urlbar-result-menu-button-feedback = Komentar
    .title = Meni wócyniś
urlbar-result-menu-learn-more2 = Dalšne informacije
    .accesskey = D
urlbar-result-menu-remove-from-history2 = Z historije wótwónoźeś
    .accesskey = h
urlbar-result-menu-tip-get-help2 = Pomoc se wobstaraś
    .accesskey = P
...
urlbar-serial-blocked =
    .tooltiptext = Sćo blokěrował pśistup k serijowemu portoju za toś to websedło.
...
clear-search-history =
    .label = Pytańsku historiju wuprozniś
    .accesskey = P
...
quickactions-cmd-manageai = KI znjemóžniś, KI zastojaś
...
quickactions-colorpicker = Wubjeŕśo barwu
quickactions-cmd-colorpicker = wuběrak barwow, barwowa pipeta, barwu wubraś
...
quickactions-editpdf = PDF-editor wócyniś
...
quickactions-labs = { -firefoxlabs-brand-name } wócyniś
...
identity-custom-root = Zwisk jo se pśeglědował pśez certifikatowego wudawarja, kótaryž njejo pśipóznaty wót BrowserWorks.
...
identity-etsi = Kwalificěrowany kaž w póstajenju (EU) 2024/1183 pódany.
identity-description-custom-root2 = BrowserWorks toś togo certifikatowego wudawarja njepśipóznawa. Jo se snaź pśidał pśez waš źěłowy system abo wót administratora.
identity-cert-exception-overridden = Sćo wěstotne wuwześe za toś to sedło pśidał.
...
urlbar-result-action-move-tab-to-split-view = Rejtarik do źělonego naglěda pśesunuś
...
urlbar-result-addons-subtitle = Rozšyrjenje { -brand-product-name }
...
urlbar-result-suggestion-recommended = Dopórucony
...
urlbar-result-explanation-last-visited-relative = Slědny woglěd { $date }
...
urlbar-result-explanation-last-visited-absolute = Slědny woglěd dnja { $date }
...
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-bookmarked = Jo se { $date } ako cytańske znamje składł
# This explanation is used when the last-visited date is formatted as one of the
# following relative dates: "yesterday", "today"
# Variables:
#   $date (string) - A localized relative date string
...
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute-2 = Slědny woglěd { $date }
...
urlbar-result-realtime-opt-in-dismiss-all2 = Toś te naraźenja njepokazaś
# This string is shown in the result menu.
urlbar-result-menu-dont-show-market2 = Toś te wikowe naraźenja njepokazaś
...
urlbar-result-menu-trending-dont-show2 = Trendowe pytanja njepokazaś
    .accesskey = T
...
fullscreen-keyboardlock-exit-button = Połnu wobrazowku spušćiś (tłocćo a źaržćo Esc)
# "esc" is lowercase on mac keyboards, but uppercase elsewhere.
fullscreen-keyboardlock-exit-mac-button = Połnu wobrazowku spušćiś (tłocćo a źaržćo esc)
# Please ensure that the domain stays in the `<span data-l10n-name="domain">` markup.
# Variables
...
qrcode-panel-error =
    .message = QR-kod njedajo se generěrowaś. Pšosym wopytajśo hyšći raz.
qrcode-copy-button =
    .label = Kopěrowaś
qrcode-copy-success =
    .message = QR-kod kopěrowany do mjazywótkłada.
qrcode-copy-error =
    .message = QR-kod njedajo se kopěrowaś.
qrcode-save-button =
    .label = Składowaś
qrcode-save-success =
    .message = QR-kod jo se składował.
qrcode-save-error =
    .message = QR-kod njedajo se składowaś.
qrcode-save-title = QR-kod składowaś
