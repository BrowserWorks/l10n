...
addon-install-error-hard-blocked = { $addonName } se pśeśiwo pšawidłam BrowserWorks pśejźo a njedajo se na { -brand-short-name } instalěrowaś.
...
addon-install-error-soft-blocked = { $addonName } se pśeśiwo pšawidłam BrowserWorks pśejźo a njedajo se na { -brand-short-name } instalěrowaś.
