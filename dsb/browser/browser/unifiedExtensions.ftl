...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } se pśeśiwo pšawidłam BrowserWorks pśejźo. Jo riskantne jo wužywaś.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } znjemóžnjony
    .message =
        Toś to rozšyrjenje se pśeśiwo pšawidła, BrowserWorks pśejźo a jo se znjemóžniło.
        Móžośo jo w nastajenjam zmóžniś, ale to móžo riskantne byś.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } znjemóžnjony
    .message = Toś to rozšyrjenje se pśeśiwo pšawidłam BrowserWorks pśejźo a jo se znjemóžniło.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Někotare z wašych rozšyrjenjow su se znjemóžnili, dokulaž su se pśeśiwo pšawidłam BrowserWorks pśejšli.
        Móžośo je w nastajenjach zmóžniś, ale to móžo riskantne byś.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Někotare z wašych rozšyrjenjow su su se znjemóžnili, dokulaž se pśeśiwo pšawidłam BrowserWorks pśejdu.
