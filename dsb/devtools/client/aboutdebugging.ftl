...
about-debugging-browser-version-too-old-fennec = Toś ta wersija Waterfox njamóžo Waterfox za Android (68) za zmólkami pśeglědowaś. Pórucamy, až Waterfox za Android Nightly na swójom telefonje za testowanje instalěrujośo. <a>Dalšne drobnostki</a>
...
about-debugging-browser-version-too-recent = Zwězany wobglědowak jo aktualnjejšy ({ $runtimeVersion }, buildID { $runtimeID }) ako waš { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). To jo njepódpěrana konfiguracija a móžo zawinowaś, až wuwijaŕske rědy njefunkcioněruju. Pšosym aktualizěrujśo Waterfox. <a>Rozwězanje problemow</a>
