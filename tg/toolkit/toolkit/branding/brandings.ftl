...
-profiler-brand-name = Профилсози «Waterfox»
...
# and kept in English.
-firefox-suggest-brand-name = Пешниҳоди Waterfox
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Саҳифаи асосии «Waterfox»
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Намуди «Waterfox»
