...
discopane-intro3 =
    ...
    мешаванд. Дар ин маҷмуъ аз ҷониби «Waterfox» чизҳои беҳтарин барои амнияти махсус, самаранокӣ ва қобилиятнокӣ
...
addon-badge-recommended4 =
    .title = Браузери «Waterfox» танҳо он васеъшавиҳоро тавсия медиҳад, ки ба стандартҳои амният ва самаранокӣ ҷавобгӯ мебошанд
...
recommended-theme-1 = Эҳсоси эҷодӣ доред? <a data-l10n-name="link">Мавзуи худро бо «Waterfox Color» эҷод кунед.</a>
