...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Реҷаи ислоҳкунии хатоҳои USB-ро ба воситаи Waterfox дар дастгоҳи Android фаъол намоед.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ин версияи «Waterfox» наметавонад, ки хатоҳои браузери «Waterfox барои Android (68)»-ро ислоҳ кунад. Мо тавсия медиҳем, ки шумо браузери «Waterfox барои Android Nightly»-ро дар телефони худ барои санҷишҳо насб намоед. <a>Маълумоти муфассал</a>
