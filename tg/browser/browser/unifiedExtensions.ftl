...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = Ин «{ $extensionName }» сиёсати «BrowserWorks»-ро вайрон мекунад. Истифодаи он метавонад хатарнок бошад.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = «{ $extensionName }» ғайрифаъол шуд
    .message = Ин васеъшавӣ сиёсати «BrowserWorks»-ро вайрон мекунад ва ғайрифаъол шудааст. Шумо метавонед онро дар танзимот фаъол созед, аммо ин метавонад хатарнок бошад.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = «{ $extensionName }» ғайрифаъол шуд
    .message = Ин васеъшавӣ сиёсати «BrowserWorks»-ро вайрон мекунад ва ғайрифаъол шудааст.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message = Баъзе аз васеъшавиҳои шумо сиёсати «BrowserWorks»-ро вайрон мекунанд ва ғайрифаъол карда шудаанд. Шумо метавонед онҳоро дар танзимот фаъол созед, аммо ин метавонад хатарнок бошад.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Баъзе аз васеъшавиҳои шумо сиёсати «BrowserWorks»-ро вайрон мекунанд ва ғайрифаъол карда шудаанд.
