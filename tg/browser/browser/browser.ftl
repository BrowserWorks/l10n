...
urlbar-serial-notification-anchor =
    .tooltiptext = Кушодани лавҳаи унсурҳои силсилавӣ
...
identity-custom-root = Пайвастшавӣ аз тарафи барорандаи гувоҳномае тасдиқ карда шудааст, ки BrowserWorks онро эътироф намекунад.
...
identity-description-custom-root2 = BrowserWorks ин барорандаи гувоҳномаро эътироф намекунад. Эҳтимол аст, ки он аз тарафи низоми амалкунандаи шумо ё аз ҷониби маъмур илова карда шуд.
...
urlbar-result-addons-subtitle = Васеъшавии «{ -brand-product-name }»
...
urlbar-result-suggestion-recommended = Тавсияшуда
