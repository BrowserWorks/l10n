...
sync-mobile-promo = «Waterfox»-ро барои <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ё <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> боргирӣ кунед ва бо дастгоҳи мобилии худ ҳамоҳанг созед.
...
sync-engine-addons =
    ...
    .tooltiptext = Ҷузъҳои иловагӣ ва мавзуъҳо барои Waterfox-и мизи корӣ
    .accesskey = Ҷ
