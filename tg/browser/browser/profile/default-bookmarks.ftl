...
default-bookmarks-firefox-customize = Фармоишдиҳии Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ҳамроҳ шавед
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Дар бораи мо
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Манбаъҳои «Waterfox Nightly»
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Блоги «Waterfox Nightly»
...
default-bookmarks-nightly-tester-tools = Абзорҳои санҷиши нашри «Waterfox Nightly»
