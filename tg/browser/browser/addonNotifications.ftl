...
addon-install-error-hard-blocked = «{ $addonName }» сиёсатҳои «BrowserWorks»-ро вайрон мекунад ва дар «{ -brand-short-name }» насб карда намешавад.
...
addon-install-error-soft-blocked = «{ $addonName }» сиёсатҳои «BrowserWorks»-ро вайрон мекунад ва дар «{ -brand-short-name }» насб карда намешавад.
