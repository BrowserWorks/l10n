...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } парушае палітыку BrowserWorks. Яго выкарыстанне можа быць рызыкоўным.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } адключана
    .message =
        Гэта пашырэнне парушае палітыку BrowserWorks і было адключана.
        Вы можаце ўключыць яго ў наладах, але гэта можа быць рызыкоўным.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } адключана
    .message = Гэта пашырэнне парушае палітыку BrowserWorks і было адключана.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Некаторыя з вашых пашырэнняў былі адключаны за парушэнне палітык BrowserWorks.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Некаторыя з вашых пашырэнняў былі адключаны за парушэнне палітык BrowserWorks.
