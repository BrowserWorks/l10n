...
addon-install-error-hard-blocked = { $addonName } парушае палітыку BrowserWorks і не можа быць усталяваны ў { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } парушае палітыку BrowserWorks і не можа быць усталяваны ў { -brand-short-name }.
