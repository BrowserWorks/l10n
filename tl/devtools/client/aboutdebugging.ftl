...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = I-enable ang USB Debugging sa Waterfox sa Android device.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ang bersyon na ito ng Waterfox ay hindi maaaring mag-debug ng Waterfox for Android (68). Inirerekomenda naming mag-install ng Waterfox for Android Nightly sa iyong telepono para makapag-test. <a>Karagdagang detalye</a>
...
about-debugging-browser-version-too-recent = Ang nakakonektang browser ay mas bago ({ $runtimeVersion }, buildID { $runtimeID }) kaysa sa iyong { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Hindi ito suportadong setup at maaaring makasira sa DevTools. Paki-update ang Waterfox. <a>Pag-troubleshoot</a>
