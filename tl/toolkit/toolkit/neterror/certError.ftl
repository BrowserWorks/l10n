...
cert-error-mitm-mozilla = Ang { -brand-short-name } ay sinusuportahan ng non-profit na BrowserWorks, na nagbibigay ng bukas na certificate authority (CA) store. Sinisiguro ng CA store na sumusunod ang mga certificate authority sa mga best practice para sa seguridad ng user.
cert-error-mitm-connection = Ginagamit ng { -brand-short-name } ang BrowserWorks CA store para masiguro na secure ang connection, sa halip na gamitin ang mga certificate na binigay ng operating system ng user. Kaya kapag na-intercept ng isang antivirus program o network ang isang connection kung saan ang security certificate ay inissue ng isang CA na wala sa BrowserWorks CA store, ang connection ay hindi ligtas.
