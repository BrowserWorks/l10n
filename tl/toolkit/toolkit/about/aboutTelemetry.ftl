...
about-telemetry-firefox-data-doc = Ang <a data-l10n-name="data-doc-link">Waterfox Data Documentation</a> ay naglalaman ng mga gabay tungkol sa kung paano gumagana ang aming mga kagamitan sa mga datos.
about-telemetry-telemetry-client-doc = Ang <a data-l10n-name="client-doc-link">Waterfox Telemetry client documentation</a> ay naglalakip ng mga pagbigay-kahulugan para sa mga konsepto, mga dokumentasyon sa API at pinanggagalingan ng mga datos.
