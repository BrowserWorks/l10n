...
identity-custom-root = Ang connection ay na-verify ng isang certificate issuer na hindi kinikilala ng BrowserWorks.
...
identity-description-custom-root2 = Hindi kilala ng BrowserWorks ang certificate issuer na ito. Maaari itong nadagdag sa iyong operating system o ng isang administrator.
...
urlbar-searchmode-popup-add-engine = I-dagdag ang “{ $engineName }”
    .title = I-dagdag ang search engine na “{ $engineName }”
