...
protections-panel-content-blocking-breakage-report-view-description = Ayrim kuzatuvchilarni bloklasangiz, baʼzi saytlarda muammo paydo boʻlishi mumkin. Bu muammo haqida xabar berish bilan siz { -brand-short-name }ni yaxshilashda yordam bergan hisoblanasiz. Bu hisobot bilan birga URL manzili va brauzeringiz sozlamalari haqidagi maʼlumotlar ham BrowserWorksga yuboriladi <label data-l10n-name="learn-more">Batafsil</label>
