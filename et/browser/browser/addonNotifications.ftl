...
addon-install-error-hard-blocked = Lisa { $addonName } rikub BrowserWorks eeskirju ja seda pole võimalik { -brand-short-name }i paigaldada.
...
addon-install-error-soft-blocked = Lisa { $addonName } rikub BrowserWorks eeskirju ja seda pole võimalik { -brand-short-name }i paigaldada.
