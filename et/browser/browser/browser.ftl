...
identity-custom-root = Ühenduse on verifitseerinud BrowserWorksle tundmatu serdi väljaandja.
...
identity-description-custom-root2 = BrowserWorks ei tea seda serdi väljaandjat. Selle võis lisada operatsioonisüsteem või süsteemiadministraator.
...
urlbar-searchmode-popup-add-engine = Lisa “{ $engineName }”
    .title = Lisa otsingumootor “{ $engineName }”
