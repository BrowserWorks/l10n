...
addon-install-error-hard-blocked = { $addonName } violescha las directivas da BrowserWorks e na po betg vegnir installà en { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } violescha las directivas da BrowserWorks e na po betg vegnir installà en { -brand-short-name }.
