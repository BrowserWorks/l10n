...
unified-extensions-item-messagebar-softblocked = { $extensionName } violescha las directivas da BrowserWorks. L’utilisaziun po esser ristgusa.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Questa extensiun violescha las directivas da BrowserWorks ed è vegnida deactivada.
        Ti pos l’activar en ils parameters, ma quai po esser ristgus.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = Deactivà { $extensionName }
    .message = Questa extensiun violescha las directivas da BrowserWorks ed è vegnida deactivada.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Tschertas da tias extensiuns èn vegnidas deactivadas perquai ch’ellas violeschan las directivas da BrowserWorks.
