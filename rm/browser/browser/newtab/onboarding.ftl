...
mr2022-onboarding-gratitude-subtitle = Grazia per utilisar { -brand-short-name } da la BrowserWorks. Cun tes agid lavurain nus per crear in internet pli avert, accessibel e meglier per mintgin.
...
onboarding-gratitude-security-and-privacy-subtitle = Grazia per utilisar { -brand-short-name } da la BrowserWorks. Cun tes agid lavurain nus per crear in internet pli segir ed accessibel per ina e mintgin.
