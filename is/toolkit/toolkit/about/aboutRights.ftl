...
rights-intro-point-1 = { -brand-short-name } er á boðstólum fyrir þig samkvæmt skilmálum <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>. Þetta þýðir að þú mátt nota, afrita og dreifa { -brand-short-name } til annarra.  Þú mátt einnig breyta frumkóða { -brand-short-name } hvernig sem þér hentar. BrowserWorks Public License gefur þér einnig rétt til að dreifa breyttum útgáfum.
rights-intro-point-2 =
    Þú hefur ekki leyfi ti lað nota vörumerki eða hefur leyfi fyrir vörumerkjum 
    frá BrowserWorks stofnunni eða öðrum aðilum, innifelur það í sér án allra takmarkana 
