...
unified-extensions-item-messagebar-softblocked = { $extensionName } brýtur gegn reglum BrowserWorks. Það getur verið áhættusamt að nota hann.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Þessi forritsauki brýtur gegn reglum BrowserWorks.
        Þú getur virkjað hann í stillingunum, en slíkt getur verið verið áhættusamt.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } óvirkt
    .message = Þessi forritsauki brýtur gegn reglum BrowserWorks og hefur verið gerður óvirkur.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message = Sumir forritsaukarnir þínir hafa verið gerðir óvirkir fyrir að brjóta gegn reglum BrowserWorks. Það getur verið áhættusamt að nota þá.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Sumir forritsaukarnir þínir hafa verið gerðir óvirkir fyrir að brjóta gegn reglum BrowserWorks.
