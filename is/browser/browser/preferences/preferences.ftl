...
sync-mobile-promo = Sæktu Waterfox fyrir <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> eða <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> til að samstilla með farsímanum.
...
sync-engine-addons =
    .label = Viðbætur
    .tooltiptext = Forritsaukar og þemu fyrir Waterfox á borðtölvu
    .accesskey = b
