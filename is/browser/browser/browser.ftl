...
identity-custom-root = Tenging staðfest af útgefanda skilríkis sem ekki er viðurkennt af BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks viðurkennir ekki þennan skilríkisútgefanda. Það kann að hafa verið bætt við af hálfu stýrikerfisins þíns eða af stjórnanda.
