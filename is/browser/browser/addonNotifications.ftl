...
addon-install-error-hard-blocked = { $addonName } brýtur gegn reglum BrowserWorks og er því ekki hægt að setja það upp á { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } brýtur gegn reglum BrowserWorks og er því ekki hægt að setja það upp á { -brand-short-name }.
