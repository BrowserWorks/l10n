...
onboarding-animation-pause-button =
    .aria-label = მოძრაობის შეჩერება
onboarding-animation-play-button =
    .aria-label = ამოძრავება
...
mr2022-onboarding-gratitude-subtitle = გმადლობთ, რომ აირჩიეთ { -brand-short-name } არამომგებიანი BrowserWorks-ფონდისგან. თქვენი მხარდაჭერით შევძლებთ, რომ ინტერნეტი გავხადოთ მეტად ღია, უკეთესი და საყოველთაოდ ხელმისაწვდომი.
...
onboarding-gratitude-security-and-privacy-subtitle = გმადლობთ, რომ აირჩიეთ { -brand-short-name } არამომგებიანი BrowserWorks-ფონდისგან. თქვენი მხარდაჭერით ვცდილობთ ინტერნეტი გავხადოთ მეტად უსაფრთხო და საყოველთაოდ ხელმისაწვდომი.
...
restored-from-backup-error-subtitle = თუ სხვა ფაილშიც გაქვთ { -brand-short-name } დამარქაფებული, მოსინჯეთ იმ ფაილიდან აღდგენა. <a data-l10n-name="restore-problems">მაინც არ მოგვარდა?</a>
