...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } არღვევს BrowserWorks-ს დებულებებს. მისი გამოყენება შეიძლება სახიფათო იყოს.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } ამორთულია
    .message =
        გაფართოება არღვევს BrowserWorks-ს დებულებებს.
        მისი გამოყენება შესაძლოა სახიფათო იყოს.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } ამორთულია
    .message = გაფართოება არღვევს BrowserWorks-ს დებულებებს და ამორთულია
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        ზოგიერთი გაფართოება ამორთულია BrowserWorks-ს დებულებების დარღვევის გამო.
        მათი ჩართვა შეგიძლიათ პარამეტრებიდან, მაგრამ შესაძლოა, სახიფათო იყოს.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = თქვენი ზოგიერთი გაფართოება ამორთულია BrowserWorks-ს დებულებების დარღვევის გამო.
