...
discopane-intro3 =
    ...
    შედეგიანობა, მასალებით სარგებლობა, შეამკოთ { -brand-product-name } სურვილისამებრ და გააკეთოთ სხვა უამრავი რამ. ეს მცირე პროგრამები უმეტესად რიგითი, უცხო ხალხის მიერაა შექმნილი. იხილეთ მათგან საუკეთესო, რომელთაც <a data-l10n-name="learn-more-trigger">გირჩევთ</a> Waterfox
...
addon-badge-recommended4 =
    .title = Waterfox მხოლოდ იმ გაფართოებებს გირჩევთ, რომლებიც აკმაყოფილებს უსაფრთხოებისა და წარმადობის მაღალ მოთხოვნებს
...
recommended-theme-1 = შემოქმედებით უნარებს ფლობთ? <a data-l10n-name="link">საკუთარის ასაწყობად გამოიყენეთ Waterfox Color.</a>
