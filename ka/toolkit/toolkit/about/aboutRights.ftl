...
rights-intro-point-2 = თქვენ არ გეძლევათ არანაირი უფლება ან ლიცენზია, BrowserWorks-ის ან მისი რომელიმე მხარის სავაჭრო ნიშნებზე, მათ შორის Waterfox-ის სახელის ან ლოგოს შეუზღუდავ გამოყენებაზე. დამატებითი ინფორმაცია სავაჭრო ნიშნების შესახებ, შეგიძლიათ მოიძიოთ <a data-l10n-name="mozilla-trademarks-link">აქ</a>.
