...
# and kept in English.
-firefox-suggest-brand-name = Waterfox-შეთავაზება
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name =
    { $case ->
        [dat] Waterfox-მთავარს
        [loc] Waterfox-მთავარზე
       *[nom] Waterfox-მთავარი
    }
...
# and kept in English.
-firefoxlabs-brand-name = Waterfox-საცდეო
