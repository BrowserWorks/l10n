...
addon-badge-recommended4 =
    .title = Waterfox jenož rozšěrjenja doporučuje, kotrež standardam za wěstotu a wukon wotpowěduja.
...
recommended-theme-1 = Čujeće so kreatiwny? <a data-l10n-name="link">Wutworće swójsku drastu z Waterfox Color.</a>
