...
onboarding-animation-pause-button =
    .aria-label = Animaciju zastajić
onboarding-animation-play-button =
    .aria-label = Animaciju wothrać
...
mr2022-onboarding-live-language-continue-in = Z rěču { $appLanguage } pokročować
...
mr2022-onboarding-gratitude-subtitle = Wulki dźak, zo { -brand-short-name } wužiwaće, kotryž so wot załožby BrowserWorks spěchuje. Z wašej pomocu dźěłamy na tym, internet bóle wotewrjeny, přistupny a lěpši za kóždeho činić.
...
onboarding-gratitude-security-and-privacy-subtitle = Wulki dźak, zo { -brand-short-name } wužiwaće, kotryž so wot załožby BrowserWorks spěchuje. Z wašej pomocu dźěłamy na tym, internet wěsćiši a přistupniši za kóždeho činić.
...
onboarding-refresh-pin-set-default-subtitle = Škitamy waše daty a haćimy předewzaća při wuskušowanju, hdyž klikaće – awtomatisce.
