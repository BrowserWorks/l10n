...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } so přećiwo prawidłam BrowserWorks přeńdźe. Je riskantne jo wužiwać.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } znjemóžnjeny
    .message =
        Tute rozšěrjenje so přećiwo prawidłam BrowserWorks přeńdźe a je so znjemóžniło.
        Móžeće jo w nastajenjach zmóžnić, ale to móže riskantne być.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } znjemóžnjeny
    .message = Tute rozšěrjenje so přećiwo prawidłam BrowserWorks přeńdźe a je so znjemóžniło.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Někotre z wašich rozšěrjenjow su so znjemóžnili, dokelž su so přećiwo prawidłam BrowserWorks přešli.
        Móžeće je w nastajenjach zmóžnić, ale to móže riskantne być.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Někotre z wašich nastajenjow su so znjemóžnili, dokelž su so přećiwo prawidłam BrowserWorks přešli.
