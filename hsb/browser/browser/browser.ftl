...
popups-infobar-dont-show-message2 =
    .label = Tutu zdźělenku njepokazać, hdyž so wuskakowace wokna abo dalesposrědkowanja třećich poskićowarjow blokuja
    .accesskey = T
...
urlbar-result-menu-button-feedback = Komentar
    .title = Meni wočinić
urlbar-result-menu-learn-more2 = Dalše informacije
    .accesskey = D
urlbar-result-menu-remove-from-history2 = Z historije wotstronić
    .accesskey = h
urlbar-result-menu-tip-get-help2 = Pomoc wobstarać
    .accesskey = P
...
urlbar-popup-blocked2 =
    .tooltiptext = Sće wuskakowace wokna a dalesposrědkowanja třećich poskićowarjow za tute websydło zablokował.
...
quickactions-mute = Rajtarki zněmić, kotrež awdio wothrawaja
# List of words that would trigger the "mute tabs" action from the address bar.
# Replace with idiomatic expressions in your language to silence something or
# someone.
quickactions-cmd-mute = pst, š, ps, pš, st
...
quickactions-editpdf = PDF-editor wočinić
...
quickactions-translate = Přełožić
quickactions-cmd-translate = přełožić
...
quickactions-labs = { -firefoxlabs-brand-name } wočinić
...
identity-custom-root = Zwisk je so přez certifikatoweho wudawarja přepruwował, kotryž wot BrowserWorks připóznaty njeje.
...
identity-description-custom-root2 = BrowserWorks tutoho certifikatoweho wudawarja njepřipóznawa. Je so snano přez waš dźěłowy system abo wot administratora přidał.
identity-cert-exception-overridden = Sće wěstotne wuwzaće za tute sydło přidał.
...
urlbar-extension =
    .value = Rozšěrjenje:
urlbar-go-button2 =
    .title = K adresy w adresowym polu
urlbar-go-button =
...
urlbar-result-action-move-tab-to-split-view = Rajtark do dźěleneho napohlada přesunyć
...
urlbar-result-addons-subtitle = Rozšěrjenje { -brand-product-name }
...
urlbar-result-suggestion-recommended = Doporučeny
...
urlbar-result-action-ai-chat = Prašeć so
...
urlbar-result-explanation-last-visited-relative = Posledni wopyt { $date }
...
urlbar-result-explanation-last-visited-weeks =
    { $weeksAgo ->
        [one] Posledni wopyt před { $weeksAgo } tydźeń
        [two] Posledni wopyt před { $weeksAgo } njedźeli
        [few] Posledni wopyt před { $weeksAgo } njedźele
       *[other] Posledni wopyt před { $weeksAgo } njedźel
    }
...
urlbar-result-explanation-last-visited-months =
    { $monthsAgo ->
        [one] Posledni wopyt před { $monthsAgo } měsac
        [two] Posledni wopyt před { $monthsAgo } měsacaj
        [few] Posledni wopyt před { $monthsAgo } měsacy
       *[other] Posledni wopyt před { $monthsAgo } měsacow
    }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute = Posledni wopyt dnja { $date }
...
urlbar-result-realtime-opt-in-dismiss-all2 = Tute namjety njepokazać
# This string is shown in the result menu.
urlbar-result-menu-dont-show-market2 = Wične namjety njepokazać
...
urlbar-result-aria-group-market =
    .aria-label = Namjety akcijowych wikow
...
urlbar-searchmode-button3 =
    .title = { $engine }, wubjerće pytawu
urlbar-searchmode-button-no-engine2 =
    .title = Žana skrótšenka wubrana, wubjerće skrótšenku
...
urlbar-searchmode-default2 =
    .title = Standardna pytawa
# Shown when adding new search engines from the search mode switcher.
# Variables:
#  $engineName (String): The name of the search engine.
urlbar-searchmode-popup-add-engine = „{ $engineName }“ přidać
    .title = Pytawu „{ $engineName }“ přidać
# Label shown on the top of Searchmode Switcher popup. After this label, the
# available search engines will be listed.
urlbar-searchmode-popup-one-off-header = Tónkróć pytać z:
...
urlbar-result-menu-trending-dont-show2 = Trendowe pytanja njepokazać
    .accesskey = T
...
menu-share-copy-links =
    .label =
        { $count ->
            [one] { $count } wotkaz kopěrować
            [two] { $count } wotkazaj kopěrować
            [few] { $count } wotkazy kopěrować
           *[other] { $count } wotkazow kopěrować
        }
    .accesskey = k
...
reset-pbm-panel-description2 = To historiju, placki a wšě waše druhe sydłowe daty zhaša, bjeztoho zo by so priwatne wokno začiniło.
...
trustpanel-blocker-section-header2 =
    { $count ->
        ...
        [two] <span data-l10n-name="count">{ $count }</span> přesćěhowakaj stej so na tutym sydle zablokowałoj
...
reduced-protection-infobar-reload-button = Znowa začitać
    .accesskey = Z
reduced-protection-infobar-never-show-button = Hižo so njepokazać
    .accesskey = H
