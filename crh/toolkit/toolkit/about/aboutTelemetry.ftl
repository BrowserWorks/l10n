...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Waterfox Veriler Tavsiqi</a> veriler aletlerimiz içün nasıl çalışılğanı aqqında rehberlerni ihtiva ete.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox Telemetri müşteri tavsiqi</a> qavramlar içün tariflerni, API (UPA) tavsiqini ve veriler sıltavlarını ihtiva ete.
