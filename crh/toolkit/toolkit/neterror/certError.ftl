...
cert-error-mitm-mozilla = { -brand-short-name } tatbiqine arqa çıqqan kâr maqsatı kütmegen BrowserWorks, tamamen açıq bir şeadetname salâhiyeti (CA; ŞS) mağazını idare eter. CA mağazı, şeadetname salâhiyetleriniñ qullanıcı emniyeti içün eñ yahşı ameliyatnı taqip etmelerini temin etmege yardım eter.
cert-error-mitm-connection = { -brand-short-name }, bir bağlantınıñ emniyetli olğanını doğrulamaq içün, qullanıcınıñ işletim sistemi tarafından temin etilgen şeadetnameler yerine, BrowserWorks CA mağazını qullanır. Bundan dolayı, bir antivirus programı yaki bir şebeke, BrowserWorks CA mağazında bulunmağan bir CA tarafından ihrac etilgen bir emniyet şeadetnamesi ile bir bağlantınınıñ yolunı kesse, bağlantı ğayrı-emin mülâhaza etilir.
