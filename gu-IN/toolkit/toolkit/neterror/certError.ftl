...
cert-error-mitm-mozilla = { -brand-short-name } નો નફાકારક BrowserWorks દ્વારા સમર્થન છે, જે સંપૂર્ણપણે ખુલ્લા પ્રમાણપત્ર અધિકારી (CA) સ્ટોરનું સંચાલન કરે છે. CA સ્ટોર એ સુનિશ્ચિત કરવામાં સહાય કરે છે કે પ્રમાણપત્ર અધિકારીઓ વપરાશકર્તા સુરક્ષા માટે શ્રેષ્ઠ પ્રયાસોનું પાલન કરે છે.
cert-error-mitm-connection = { -brand-short-name } એ BrowserWorks CA સ્ટોરનો ઉપયોગ કરે છે કે જે યુઝરની ઑપરેટિંગ સિસ્ટમ દ્વારા પ્રમાણિત કરેલા પ્રમાણપત્રોને બદલે કનેક્શન સુરક્ષિત છે તે ચકાસવા માટે. તેથી, જો એન્ટીવાયરસ પ્રોગ્રામ અથવા નેટવર્ક CA દ્વારા જારી કરાયેલ સુરક્ષા પ્રમાણપત્ર સાથે કનેક્શનને અટકાવી રહ્યું છે જે BrowserWorks CA સ્ટોરમાં નથી, તો કનેક્શનને અસુરક્ષિત માનવામાં આવે છે.
