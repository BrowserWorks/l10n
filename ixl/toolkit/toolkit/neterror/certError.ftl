...
cert-error-mitm-connection = { -brand-short-name } b'anb'e u molb'al tetze' BrowserWorks CA aq'al uva' la ilaxi uva' b'a'n kuxh tatine'. a'e' la b'anb'e ti' unq'a tu'aal unq'a ch'ich'e uve' ni b'anb'ele'. Ech sti'e', asoj la b'ane' uva' ni majon ivatz u u'aale' uve' ate'l tzan ta'n u CA as ye'xh kam at kan tu molb'al taq'on u BrowserWorks CA a' la alon uva' ye'xh kam b'a'n taq'onve' la ib'ane'.
