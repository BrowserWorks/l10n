...
mr2022-onboarding-gratitude-subtitle = Grazas por usar { -brand-short-name }, apoiado pola Fundación BrowserWorks. Co teu apoio, traballamos para facer que internet sexa máis aberta, accesible e mellor para todos.
...
onboarding-gratitude-security-and-privacy-subtitle = Grazas por usar { -brand-short-name }, apoiado pola Fundación BrowserWorks. Co teu apoio, traballamos para que Internet sexa máis seguro e accesible para todos.
