...
unified-extensions-item-messagebar-softblocked = { $extensionName } infrinxe as políticas de BrowserWorks. Usala pode ser arriscado.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Esta extensión infrinxe as políticas de BrowserWorks e desactivouse.
        Podes activala na configuración, pero pode ser arriscado.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } desactivada
    .message = Esta extensión infrinxe as políticas de BrowserWorks e desactivouse.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Algunhas das túas extensións deshabilitáronse por infrinxir as políticas de BrowserWorks.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Algunhas das túas extensións desactiváronse por infrinxir as políticas de BrowserWorks.
