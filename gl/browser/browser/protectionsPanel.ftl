...
protections-panel-content-blocking-breakage-report-view-description = Bloquear certos rastreadores pode causar problemas con algúns sitios web. Informar destes problemas axuda a que { -brand-short-name } sexa mellor para todos. O envío deste informe enviará un URL e información sobre a configuración do seu navegador a BrowserWorks. <label data-l10n-name="learn-more">Máis información</label>
