...
identity-custom-root = Conexión comprobada por un emisor de certificados que non é recoñecido por BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks non recoñece este emisor de certificados. É posible que fora engadido desde o sistema operativo ou por un administrador. <label data-l10n-name = "link"> Máis información </label
...
urlbar-result-realtime-opt-in-allow = Amosar suxestións
