...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Active a depuración por USB en Waterfox no dispositivo Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Esta versión de Waterfox non pode depurar Waterfox para Android (68). Recomendamos instalar Waterfox para Android Nightly no teléfono para probalo. <a>Máis detalles</a>
...
about-debugging-browser-version-too-recent = O navegador conectado é máis recente ({ $runtimeVersion }, buildID { $runtimeID }) que o seu { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Esta é unha configuración non compatible e pode causar que DevTools falle. Actualice Waterfox. <a>Resolución de problemas</a>
