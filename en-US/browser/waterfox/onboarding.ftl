...
waterfox-onboarding-tabs-style-legend = Browser style
...
waterfox-onboarding-tabs-density-legend = Density
...
waterfox-onboarding-theme-color-legend = Theme color
...
waterfox-onboarding-tabs-layout-legend = Tab arrangement
...
waterfox-onboarding-tabs-location-label = Tab strip position
