...
sync-mobile-promo = Baxa Waterfox <img data-l10n-name="android-icon"/> p'<a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> pa sincronizar col to preséu móvil.
...
sync-engine-addons =
    .label = Complementos
    .tooltiptext = Les estensiones y los estilos pal Waterfox d'escritoriu
    .accesskey = C
