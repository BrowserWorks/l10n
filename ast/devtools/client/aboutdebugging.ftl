...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activa la depuración per USB en Waterfox p'Android
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Esta versión de Waterfox nun pue depurar Waterfox p'Android (68). Aconseyámoste instalar Waterfox Nightly p'Android nel preséu pa facer pruebes. <a>Más detalles</a>
