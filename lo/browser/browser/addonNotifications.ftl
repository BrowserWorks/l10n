...
addon-install-error-hard-blocked = { $addonName } ລະເມີດນະໂຍບາຍຂອງ BrowserWorks ແລະ ບໍ່ສາມາດຕິດຕັ້ງໄດ້ໃນ { -brand-short-name }.
addon-install-error-blocklisted = { $addonName } ບໍ່ສາມາດຕິດຕັ້ງໄດ້ເພາະວ່າມັນມີຜົນກະທົບສູງຕໍ່ຄວາມສະຖຽນ ແລະ ບັນຫາຄວາມປອດໄພ.
addon-install-error-soft-blocked = { $addonName } ລະເມີດນະໂຍບາຍຂອງ BrowserWorks ແລະ ບໍ່ສາມາດຕິດຕັ້ງໄດ້ໃນ { -brand-short-name }.
