...
urlbar-result-menu-button-feedback = ຄຳຕິຊົມ
    .title = ເປິດເມນູ
urlbar-result-menu-learn-more2 = ຮຽນຮູ້ເພີ່ມເຕີມ
    .accesskey = L
urlbar-result-menu-remove-from-history2 = ລຶບອອກຈາກປະຫວັດ
    .accesskey = R
urlbar-result-menu-tip-get-help2 = ຂໍຄວາມຊ່ວຍເຫຼືອ
    .accesskey = h
urlbar-result-menu-dismiss-suggestion2 = ປິດການແນະນຳນີ້
    .accesskey = D
urlbar-result-menu-manage-firefox-suggest2 = ຈັດການ { -firefox-suggest-brand-name }
    .accesskey = M
...
urlbar-result-menu-report-inaccurate-location2 = ລາຍງານສະຖານທີ່ບໍ່ຖືກຕ້ອງ
urlbar-result-menu-show-less-frequently2 = ສະແດງໜ້ອຍລົງເລື້ອຍໆ
urlbar-result-menu-dont-show-weather-suggestions2 = ຢ່າສະແດງຄຳແນະນຳສະພາບອາກາດ
...
identity-custom-root = ການເຊື່ອມຕໍ່ທີ່ກວດສອບໂດຍຜູ້ອອກໃບຢັ້ງຢືນທີ່ BrowserWorks ບໍ່ຮັບຮູ້.
...
identity-description-custom-root2 = BrowserWorks ບໍ່ຮູ້ຈັກຜູ້ອອກໃບຢັ້ງຢືນນີ້. ມັນອາດຈະຖືກເພີ່ມຈາກລະບົບປະຕິບັດການຂອງທ່ານ ຫຼືໂດຍຜູ້ເບິ່ງແຍງລະບົບ.
...
urlbar-result-action-tab-group-unnamed = ກຸ່ມທີ່ບໍ່ມີຊື່
...
urlbar-result-weather-title = <strong>{ $temperature }°{ $unit }</strong> ໃນ { $city }, { $region }
...
urlbar-result-weather-title-with-country = <strong>{ $temperature }°{ $unit }</strong> ໃນ { $city }, { $region }, { $country }
...
urlbar-result-realtime-opt-in-dismiss-all2 = ຢ່າສະແດງຄໍາແນະນໍາເຫຼົ່ານີ້
# This string is shown in the result menu.
urlbar-result-menu-dont-show-market2 = ຢ່າສະແດງຄໍາແນະນໍາໃນຕະຫຼາດ
...
urlbar-result-dates-ongoing = { $name } · ສິ້ນສຸດໃນ { $daysUntilEnd } ມື້
# The name of an event and a note that it is happening today separated by a
# middot.
# Variables:
#   $name (string) - The name of the event.
urlbar-result-dates-today = { $name } · ມື້ນີ້
# The name of multiple day long event and a note that it is ends today
# separated by a middot.
# Variables:
#   $name (string) - The name of the event.
urlbar-result-dates-ends-today = { $name } · ສິ້ນສຸດມື້ນີ້
...
firefox-relay-offer-legal-notice-1 = ໂດຍການລົງທະບຽນ ແລະ ສ້າງໂຕປົກປິດອີເມວ, ທ່ານເຫັນດີນຳ <label data-l10n-name="tos-url">ເງື່ອນໄຂການໃຫ້ບໍລິການ</label> ແລະ <label data-l10n-name="privacy-url">ປະກາດຄວາມເປັນສ່ວນຕົວ</label>.
...
trustpanel-header-disabled = ທ່ານໄດ້ປິດການປ້ອງກັນ
...
trustpanel-clear-cookies-description = ການລຶບຄຸກກີ້ ແລະ ຂໍ້ມູນເວັບໄຊອາດຈະເຮັດໃຫ້ທ່ານອອກຈາກເວັບໄຊທ໌ ແລະ ລຶບລ້າງກະຕ່າຊື້ເຄື່ອງ.
