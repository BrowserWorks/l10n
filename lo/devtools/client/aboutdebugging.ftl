...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = ເປີດໃຊ້ການດີບັກ USB ໃນ Waterfox ໃນອຸປະກອນ Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Waterfox ລຸ້ນນີ້ບໍ່ສາມາດແກ້ບັນຫາ Waterfox ສໍາລັບ Android (68). ພວກເຮົາແນະນໍາໃຫ້ຕິດຕັ້ງ Waterfox ສໍາລັບ Android Nightly ໃນໂທລະສັບຂອງທ່ານເພື່ອທົດສອບ. <a>ລາຍລະອຽດເພີ່ມເຕີມ</a>
...
about-debugging-browser-version-too-recent = ຕົວທ່ອງເວັບທີ່ເຊື່ອມຕໍ່ແມ່ນຫລ້າສຸດ ({ $runtimeVersion }, buildID { $runtimeID }) ຫຼາຍກວ່າ { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). ນີ້ແມ່ນການຕັ້ງຄ່າທີ່ບໍ່ຮອງຮັບ ແລະອາດເຮັດໃຫ້ DevTools ລົ້ມເຫລວ. ກະລຸນາອັບເດດ Waterfox. <a>ການແກ້ໄຂບັນຫາ</a>
