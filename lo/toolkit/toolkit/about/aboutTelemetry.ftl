...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">ຂໍ້ມູນເອກະສານຂອງ Waterfox</a> ປະກອບມີຄູ່ມືກ່ຽວກັບວິທີການເຮັດວຽກກັບເຄື່ອງມືຂໍ້ມູນຂອງພວກເຮົາ.
