...
cert-error-mitm-mozilla = { -brand-short-name } ໄດ້ຮັບການສະໜັບສະໜູນໂດຍ BrowserWorks ທີ່ບໍ່ຫວັງຜົນກຳໄລ, ເຊິ່ງຄຸ້ມຄອງຮ້ານຂາຍໃບຮັບຮອງທີ່ເປີດຢ່າງຄົບຖ້ວນ (CA). ຮ້ານ CA ຊ່ວຍຮັບປະກັນວ່າເຈົ້າຫນ້າທີ່ໃບຢັ້ງຢືນກໍາລັງປະຕິບັດຕາມການປະຕິບັດທີ່ດີທີ່ສຸດສໍາລັບຄວາມປອດໄພຂອງຜູ້ໃຊ້.
