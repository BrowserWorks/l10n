...
mr2022-onboarding-gratitude-subtitle = Gun robh math agad airson { -brand-short-name } a chleachdadh, brabhsair aig a bheil taic Fonndas BrowserWorks. Le do thaic-sa, tha sinn ag obair airson eadar-lìon a bhios nas fhosgailte, nas so-ruigsinniche agus nas fheàrr dhan a h-uile duine.
