...
addon-install-error-hard-blocked = Tha { $addonName } a’ briseadh poileasaidhean BrowserWorks is cha ghabh a stàladh air { -brand-short-name }.
...
addon-install-error-soft-blocked = Tha { $addonName } a’ briseadh poileasaidhean BrowserWorks is cha ghabh a stàladh air { -brand-short-name }.
