...
default-bookmarks-firefox-customize = Gnàthaich Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Gabh pàirt ann
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Mu ar dèidhinn
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Goireasan Waterfox Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Bloga Waterfox Nightly
