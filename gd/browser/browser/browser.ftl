...
identity-custom-root = Chaidh an ceangal a dhearbhadh le teisteanas nach aithnich BrowserWorks.
...
identity-description-custom-root2 = Chan aithnich BrowserWorks foillsichear an teisteanais seo. Dh’fhaoidte gun do chuir an siostam-obrachaidh agad ris e no ’s dòcha rianaire.
