...
cert-error-mitm-mozilla = Tha taic a’ bhuidhinn neo-phrothaidich BrowserWorks aig { -brand-short-name } agus tha iad a’ rianachd ùghdarras theisteanasan (CA) fosgailte. Tha stòras an CA a’ dèanamh cinnteach gu bheil ùghdarrasan nan teisteanasan a’ leantainn nan riaghailtean a mholar airson tèarainteachd chleachdaichean.
cert-error-mitm-connection = Tha { -brand-short-name } a’ cleachdadh stòras CA BrowserWorks airson dearbhadh gu bheil ceangal tèarainte, seach teisteanasan a sholair siostam-obrachaidh a’ chleachdaiche. Ma tha prògram an aghaidh bhìorasan no lìonra ag eadar-cheapadh ceangal le teisteanas tèarainteachd a chaidh fhoillseachadh le CA nach eil ann an stòras CA BrowserWorks, tuigear dheth nach eil an ceangal sàbhailte.
