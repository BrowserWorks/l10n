...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } bryter med BrowserWorkss retningslinjer. Å bruke den kan være risikabelt.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } deaktivert
    .message =
        Denne utvidelsen bryter med BrowserWorkss retningslinjer og er deaktivert.
        Du kan aktivere den i innstillingene, men dette kan være risikabelt.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } deaktivert
    .message = Denne utvidelsen bryter med BrowserWorkss retningslinjer og er deaktivert.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Noen dine utvidelser er deaktivert fordi de bryter med BrowserWorkss retningslinjer.
        Du kan aktivere dem i innstillingene, men dette kan være risikabelt.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Noen av dine utvidelser er deaktiverte fordi de bryter med BrowserWorkss retningslinjer.
