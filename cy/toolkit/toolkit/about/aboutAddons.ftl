...
discopane-intro3 =
    ...
    drydydd partïon. Dyma ddewis o'r rhai y mae Waterfox  yn eu
...
addon-badge-recommended4 =
    .title = Dim ond estyniadau sy'n cwrdd â'n safonau diogelwch a pherfformiad y mae Waterfox yn eu hargymell
...
recommended-theme-1 = Teimlo'n greadigol? <a data-l10n-name="link">Adeiladwch eich thema eich hun gyda Waterfox Color. </a>
