...
cert-error-mitm-mozilla = Mae { -brand-short-name } yn cael ei gefnogi gan BrowserWorks y corff dim-er-elw, sy'n gweinyddu storfa awdurdod tystysgrifau (CA) cwbl agored. Mae'r storfa'n cynorthwyo i sicrhau fod awdurdodau tystysgrif yn dilyn ymarfer gorau ar gyfer diogelwch defnyddwyr.
cert-error-mitm-connection = Mae { -brand-short-name } yn defnyddio storfa CA BrowserWorks i wirio bod cysylltiad yn ddiogel, yn hytrach na thystysgrifau wedi eu cyflenwi gan system weithredu'r defnyddiwr. Felly, os yw rhaglen gwrth-firws neu rwydwaith yn rhyng-gipio cysylltiad â thystysgrif diogelwch a gyhoeddwyd gan CA nad yw yn storfa CA BrowserWorks, mae'n ystyried bod y cysylltiad yn anniogel.
