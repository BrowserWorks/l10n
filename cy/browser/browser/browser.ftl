...
urlbar-result-menu-button-feedback = Adborth
    .title = Agor dewislen
urlbar-result-menu-learn-more2 = Darllen rhagor
    .accesskey = D
urlbar-result-menu-remove-from-history2 = Tynnu o'r hanes
    .accesskey = T
...
identity-custom-root = Dilyswyd y cysylltiad gan gyhoeddwr tystysgrif nad yw'n cael ei gydnabod gan BrowserWorks.
...
identity-description-custom-root2 = Nid yw BrowserWorks yn cydnabod y cyhoeddwr tystysgrif hwn. Efallai ei fod wedi'i ychwanegu o'ch system weithredu neu gan weinyddwr.
...
urlbar-result-addons-subtitle = Estyniad { -brand-product-name }
...
urlbar-result-suggestion-recommended = Cymeradwy
...
urlbar-result-explanation-last-visited-relative = Ymwelwyd diwethaf { $date }
...
urlbar-result-explanation-last-visited-days =
    { $daysAgo ->
        [zero] Ymwelwyd diwethaf { $daysAgo } dyddiau yn ôl
...
urlbar-result-explanation-last-visited-absolute = Ymwelwyd diwethaf ar { $date }
...
urlbar-result-menu-trending-dont-show2 = Peidio â dangos chwiliadau tuedd
    .accesskey = P
...
qrcode-panel-error =
    .message = Wedi methu cynhyrchu'r cod QR. Ceisiwch eto.
qrcode-copy-button =
    .label = Copïo
qrcode-copy-success =
    .message = QR wedi ei gopïo i’r clipfwrdd
qrcode-copy-error =
    .message = Wedi methu â chopïo'r cod QR.
qrcode-save-button =
    .label = Cadw
qrcode-save-success =
    .message = Cod QR wedi'i gadw.
qrcode-save-error =
    .message = Wedi methu cadw'r cod QR.
qrcode-save-title = Cadw'r Cod QR
qrcode-save-filter-png = Delwedd PNG
...
menu-share-copy-links =
    .label =
        { $count ->
            [zero] Copïo { $count } Dolenni
            [one] Copïo Dolen
            [two] Copïo { $count } Ddolen
            [few] Copïo { $count } Dolen
            [many] Copïo { $count } Dolen
           *[other] Copïo { $count } Dolen
        }
    .accesskey = D
