...
addon-install-error-hard-blocked = Mae { $addonName } yn groes i bolisïau BrowserWorks ac nid oes modd ei osod ar { -brand-short-name }.
...
addon-install-error-soft-blocked = Mae { $addonName } yn groes i bolisïau BrowserWorks ac nid oes modd ei osod ar { -brand-short-name }.
