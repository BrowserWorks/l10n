...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = Mae { $extensionName } yn groes i bolisïau BrowserWorks. Gall fod yn beryglus ei ddefnyddio.
...
unified-extensions-mb-blocklist-warning-single =
    ...
    .message =
        Mae'r estyniad hwn yn torri polisïau BrowserWorks ac mae wedi'i analluogi.
        Gallwch ei alluogi yn y gosodiadau, ond gall hyn fod yn beryglus.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = Analluogwyd { $extensionName }
    .message = Mae'r estyniad hwn yn torri polisïau BrowserWorks ac mae wedi'i analluogi.
# Variables:
    ...
    .heading =
        { $extensionsCount ->
            [zero]
                ...
                Mae rhai o'ch estyniadau wedi'u hanalluogi am dorri polisïau BrowserWorks
                Gallwch eu galluogi yn y gosodiadau, ond gall hynny fod yn beryglus.
            [one]
                Analluogwyd estyniad { $extensionsCount } 
                Mae un o'ch estyniadau wedi'i analluogi am dorri polisïau BrowserWorks
...
unified-extensions-mb-blocklist-error-multiple =
    .heading =
        { $extensionsCount ->
            [zero]
                Analluogwyd estyniad  { $extensionsCount } 
                Mae rhai o'ch estyniadau wedi eu hanalluogi am dorri polisïau BrowserWorks.
            [one]
                Analluogwyd estyniad  { $extensionsCount } 
                Mae un o'ch estyniadau wedi ei analluogi am dorri polisïau BrowserWorks.
            [two]
                Analluogwyd estyniad  { $extensionsCount } 
                Mae rhai o'ch estyniadau wedi eu hanalluogi am dorri polisïau BrowserWorks.
            [few]
