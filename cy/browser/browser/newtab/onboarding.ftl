...
onboarding-animation-pause-button =
    .aria-label = Oedi'r animeiddiad
onboarding-animation-play-button =
    .aria-label = Chwarae animeiddiad
...
mr2022-onboarding-gratitude-subtitle = Diolch am ddefnyddio { -brand-short-name }, gyda chefnogaeth y BrowserWorks. Gyda'ch cefnogaeth chi, rydyn ni'n gweithio i wneud y rhyngrwyd yn fwy agored, hygyrch, ac yn well i bawb.
...
onboarding-gratitude-security-and-privacy-subtitle = Diolch am ddefnyddio { -brand-short-name }, gan y BrowserWorks. Gyda'ch cefnogaeth chi, rydyn ni'n gweithio i wneud y rhyngrwyd yn fwy agored, hygyrch, ac yn well i bawb.
...
fx-backup-opt-in-filepath-label = Dewiswch fan rydych chi'n bwriadu ei drosglwyddo i ddyfais newydd, fel OneDrive.
