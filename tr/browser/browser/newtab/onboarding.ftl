...
onboarding-animation-pause-button =
    .aria-label = Animasyonu duraklat
onboarding-animation-play-button =
    .aria-label = Animasyonu oynat
...
mr2022-onboarding-gratitude-subtitle = BrowserWorks Vakfı tarafından geliştirilen { -brand-short-name } tarayıcısını kullandığınız için teşekkür ederiz. Desteğinizle interneti herkes için daha açık, daha erişilebilir ve daha iyi bir yere dönüştürüyoruz.
...
onboarding-gratitude-security-and-privacy-subtitle = BrowserWorks Vakfı tarafından geliştirilen { -brand-short-name } tarayıcısını kullandığınız için teşekkür ederiz. Desteğinizle interneti herkes için daha güvenli ve daha erişilebilir bir yere dönüştürüyoruz.
