...
identity-custom-root = Bağlantı, BrowserWorks’nın tanımadığı bir sertifika yayıncısı tarafından doğrulandı.
...
identity-description-custom-root2 = BrowserWorks bu sertifika yayıncısını tanımıyor. İşletim sisteminiz üzerinden veya sistem yöneticiniz tarafından eklenmiş olabilir.
