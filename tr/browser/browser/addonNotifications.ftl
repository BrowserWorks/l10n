...
addon-install-error-hard-blocked = { $addonName } BrowserWorks politikalarını ihlal ettiği için { -brand-short-name } uygulamasına yüklenemiyor.
...
addon-install-error-soft-blocked = { $addonName } BrowserWorks politikalarını ihlal ettiği için { -brand-short-name } uygulamasına yüklenemiyor.
