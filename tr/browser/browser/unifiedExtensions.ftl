...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName }, BrowserWorks politikalarını ihlal ediyor. Kullanılması riskli olabilir.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } devre dışı
    .message =
        Bu uzantı BrowserWorks’nın politikalarını ihlal ettiği için devre dışı bırakıldı.
        Uzantıyı etkinleştirebilirsiniz ama bu riskli olabilir.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } devre dışı
    .message = Bu uzantı BrowserWorks’nın politikalarını ihlal ettiği için devre dışı bırakıldı.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Uzantılarınızdan bazıları BrowserWorks’nın politikalarını ihlal ettiği için devre dışı bırakıldı.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Uzantılarınızdan bazıları BrowserWorks’nın politikalarını ihlal ettiği için devre dışı bırakıldı.
