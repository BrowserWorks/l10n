...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Android cihazınızdaki Waterfox’ta USB hata ayıklamayı etkinleştirin.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Waterfox’un bu sürümü Android için Waterfox’ta (68) hata ayıklayamıyor. Test için Waterfox’un Android Nightly sürümünü telefonunuza yüklemenizi öneririz. <a>Daha fazla bilgi</a>
