...
addon-badge-recommended4 =
    .title = Waterfox yalnızca güvenlik ve performans standartlarını karşılayan uzantıları önerir
...
recommended-theme-1 = Yaratıcı gününüzde misiniz? <a data-l10n-name="link">Waterfox Color ile kendi temanızı oluşturun.</a>
