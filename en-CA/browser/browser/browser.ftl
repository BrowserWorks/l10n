...
identity-custom-root = Connection verified by a certificate issuer that is not recognized by BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks does not recognize this certificate issuer. It may have been added from your operating system or by an administrator.
