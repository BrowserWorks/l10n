...
addon-install-error-hard-blocked = { $addonName } BrowserWorks-এর নীতি লঙ্ঘন করে এবং { -brand-short-name }-এ ইনস্টল করা যাবে না৷
...
addon-install-error-soft-blocked = { $addonName } BrowserWorks-এর নীতি লঙ্ঘন করে এবং { -brand-short-name }-এ ইনস্টল করা যাবে না৷
