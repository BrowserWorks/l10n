...
cert-error-mitm-mozilla = { -brand-short-name } অলাভজনক প্রতিষ্ঠান BrowserWorks দ্বারা সমর্থিত, এটি সম্পূর্ণ স্বাধীন সার্টিফিকেট অথোরিটি (CA) স্টোর পরিচালনা করে। CA স্টোরটি নিশ্চিত করতে সহায়তা করে যে সার্টিফিকেট অথোরিটি ব্যবহারকারী সুরক্ষার জন্য সর্বোত্তম অনুশীলনগুলি অনুসরণ করছে।
cert-error-mitm-connection = { -brand-short-name } ব্যবহারকারীর অপারেটিং সিস্টেম দ্বারা সরবরাহিত সার্টিফিকেটের চেয়ে কোনও সংযোগ নিরাপদ কিনা তা যাচাই করতে BrowserWorks CA স্টোরটি ব্যবহার করে। সুতরাং, যদি কোনও অ্যান্টিভাইরাস প্রোগ্রাম বা কোনও নেটওয়ার্ক BrowserWorks CA স্টোরটিতে নেই এমন কোনও CA দ্বারা জারি করা সুরক্ষা সার্টিফিকেটের সাথে সংযোগকে বাধা দেয়, তবে সংযোগটি অনিরাপদ হিসাবে বিবেচিত হবে।
