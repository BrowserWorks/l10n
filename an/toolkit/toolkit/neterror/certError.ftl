...
cert-error-mitm-mozilla = { -brand-short-name } ye refirmau per BrowserWorks, una organización sin animo de lucro que administra un almagazén d'autoridatz de certificación (CA) ubierto de tot. L'almagazén aduya a asegurar que las autoridatz de certificación respectan las milloras practicas de seguranza pa protecher los usuarios.
cert-error-mitm-connection = { -brand-short-name } emplega l'almagazén de CA de BrowserWorks pa verfificar si una connexion ye segura, millor que con certificaus daus por o sistema operativo de l'usuario. Per ixo, si un antivirus u un ret intercepta una connexion con bell certificau dau per una CA que no ye en l'almagazén de BrowserWorks, la conexión se considera insegura.
