...
addon-badge-recommended4 =
    .title = Waterfox препоручује само додатке која испуњавају стандарде за безбедност и перформансе
...
recommended-theme-1 = Креативни сте? <a data-l10n-name="link">Направите сопствену тему помоћу Waterfox Color-а.</a>
