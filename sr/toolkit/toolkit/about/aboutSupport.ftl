...
legacy-user-stylesheets-title = Застарели кориснички стилови
legacy-user-stylesheets-enabled = Активно
legacy-user-stylesheets-stylesheet-types = Стилови
legacy-user-stylesheets-no-stylesheets-found = Нису пронађени стилови
...
app-basics-key-mozilla = Кључ BrowserWorks сервиса за локацију
...
app-basics-pointing-devices = Показивачки уређаји
# Variables:
...
place-database-last-idle-maintenance-data = Датум последњег одржавања у мировању
# Vacuum refers to a type of database maintenance process
place-database-last-vacuum-date = Датум последњег чишћења
place-database-last-integrity-corruption-date = Датум последње корупције интегритета
...
media-codec-support-sw-encoding = Софтверско кодирање
media-codec-support-hw-encoding = Хардверско кодирање
...
media-codec-support-error = Информације о подршци за кодеке нису доступне. Покушајте поново након пуштања медијске датотеке.
media-codec-support-lack-of-extension = Инсталирај додатак

## Media Content Decryption Modules (CDM)
## See EME Spec for more explanation for following technical terms
## https://w3c.github.io/encrypted-media/

media-content-decryption-modules-title = Информације о модулима за дешифровање садржаја
media-key-system-name = Назив система кључева
media-video-robustness = Робусност видеа
media-audio-robustness = Робусност звука
media-cdm-capabilities = Могућности
...
support-font-determination = Информације за решавање проблема са видљивошћу фонтова
...
support-user-namespaces-unavailable = { $status } — Ова функција није дозвољена од стране вашег система. Ово може ограничити безбедносне функције { -brand-short-name }-а.
...
support-remote-settings-title = Удаљена подешавања
support-remote-settings-status = Стање
support-remote-settings-status-ok = У реду
# Status when synchronization is not working.
support-remote-settings-status-broken = Не ради
support-remote-settings-last-check = Последња провера
support-remote-settings-local-timestamp = Локална временска ознака
support-remote-settings-sync-history = Историјат
support-remote-settings-sync-history-status = Стање
support-remote-settings-sync-history-datetime = Датум
support-remote-settings-sync-history-infos = Информације
...
pointing-device-mouse = Миш
pointing-device-touchscreen = Екран на додир
pointing-device-pen-digitizer = Дигитализатор оловке
pointing-device-none = Нема показивачких уређаја
...
content-analysis-title = Анализа садржаја (DLP)
content-analysis-active = Активно
content-analysis-connected-to-agent = Повезан са агентом
content-analysis-agent-path = Путања агента
content-analysis-agent-failed-signature-verification = Верификација потписа агента није успела
content-analysis-request-count = Број захтева
