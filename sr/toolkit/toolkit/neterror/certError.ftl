...
cert-error-mitm-mozilla =
    { -brand-short-name.gender ->
        [masculine] Иза { -brand-short-name(case: "gen") } стоји непрофитна организација BrowserWorks, која управља отвореним складиштем сертификационих тела (CA). Ово складиште осигурава да се сертификациона тела придржавају најбољих безбедносних процедура.
        [feminine] Иза { -brand-short-name(case: "gen") } стоји непрофитна организација BrowserWorks, која управља отвореним складиштем сертификационих тела (CA). Ово складиште осигурава да се сертификациона тела придржавају најбољих безбедносних процедура.
        [neuter] Иза { -brand-short-name(case: "gen") } стоји непрофитна организација BrowserWorks, која управља отвореним складиштем сертификационих тела (CA). Ово складиште осигурава да се сертификациона тела придржавају најбољих безбедносних процедура.
       *[other] Иза програма { -brand-short-name } стоји непрофитна организација BrowserWorks, која управља отвореним складиштем сертификационих тела (CA). Ово складиште осигурава да се сертификациона тела придржавају најбољих безбедносних процедура.
    }
cert-error-mitm-connection = { -brand-short-name } користи складиште сертификационих тела које обезбеђује BrowserWorks, не оперативни систем. Ако антивирусни или мрежни програм пресрећу везу помоћу безбедносног сертификата који се не налази у поменутом складишту, веза се сматра небезбедном.
