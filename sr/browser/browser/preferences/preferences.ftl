...
sync-mobile-promo = Преузмите Waterfox за <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> или <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> да бисте усклађивали податке са мобилним уређајем.
...
sync-engine-addons =
    .label = Додаци
    .tooltiptext = Додаци и теме за Waterfox на рачунару
    .accesskey = Д
