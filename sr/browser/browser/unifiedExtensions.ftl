...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } крши BrowserWorks-ине смернице. Коришћење може бити ризично.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = Додатак { $extensionName } је онемогућен
    .message =
        Овај додатак крши BrowserWorks-ине смернице и онемогућен је.
        Можете га омогућити у подешавањима, али то може бити ризично.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = Додатак { $extensionName } је онемогућен
    .message = Овај додатак крши BrowserWorks-ине смернице и онемогућен је.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    .message =
        Неки од ваших додатака су онемогућени због кршења BrowserWorks-иних смерница.
        Можете их омогућити у подешавањима, али то може бити ризично.
    .heading =
        { $extensionsCount ->
            [one] { $extensionsCount } додатак је онемогућен
...
unified-extensions-mb-blocklist-error-multiple =
    .message = Неки од ваших додатака су онемогућени због кршења BrowserWorks-иних смерница.
    .heading =
        { $extensionsCount ->
            [one] { $extensionsCount } додатак је онемогућен
            [few] { $extensionsCount } додатка су онемогућена
