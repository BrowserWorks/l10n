...
onboarding-animation-pause-button =
    .aria-label = Паузирај анимацију
onboarding-animation-play-button =
    .aria-label = Пусти анимацију
...
mr2022-onboarding-gratitude-subtitle = Хвала вам што користите { -brand-short-name }, којег подржава BrowserWorks фондација. Уз вашу подршку, настојимо да учинимо интернет бољим, отворенијим и приступачнијим местом за све.
...
onboarding-gratitude-security-and-privacy-subtitle = Хвала што користите { -brand-short-name }, којег подржава BrowserWorks фондација. Уз вашу подршку, радимо на томе да интернет буде безбеднији и приступачнији за све.
...
# Existing users
smartwindow-existing-user-fx-tou-title = Услови коришћења { -brand-product-name }-а
smartwindow-existing-user-fx-tou-body = Да бисте користили могућност { -smart-window-brand-name }, прихватите <a data-l10n-name="terms_of_use">услове коришћења</a> и ажурирано <a data-l10n-name="privacy_notice">обавештење о приватности</a>.
smartwindow-existing-user-fx-tou-accept = Прихвати
smartwindow-existing-user-fx-tou-go-back = Назад

## Smart Window about:welcome screen

smartwindow-onboarding-title = Учините могућност { -smart-window-brand-name } својим подразумеваним избором
smartwindow-onboarding-subtitle = Сумирајте, поредите и постављајте питања без прекида.
smartwindow-onboarding-primary-button = Настави
# Kit is referring to the Firefox mascot
smartwindow-onboarding-image-alt =
    .aria-label = { -brand-product-name } маскота (Кит) са реквизитима у виду звездица

## Smart Window Sidebar Auto-Open Pref

smartwindow-sidebar-auto-open-callout-title = Желите ли да држите помоћника затвореним?
smartwindow-sidebar-auto-open-callout-body = И даље га можете отворити када год вам буде потребан.
smartwindow-sidebar-auto-open-callout-accept = Да, држи затвореним
smartwindow-sidebar-auto-open-callout-dismiss = Не, хвала
smartwindow-sidebar-auto-open-callout-accepted-title = Помоћник ће остати затворен
