...
rights-intro-point-2 = לא הוענקה לך אף זכות בסמל המסחרי או רישיונות לסמל המסחרי של קרן BrowserWorks או חלקן, לא כולל הגבלה על השם או הלוגו של Waterfox. מידע נוסף על הסמלים המסחריים נמצא <a data-l10n-name="mozilla-trademarks-link">כאן</a>.
