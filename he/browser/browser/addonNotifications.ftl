...
addon-install-error-hard-blocked = התוספת { $addonName } מפרה את המדיניות של BrowserWorks ולכן לא ניתן להתקין אותה ב־{ -brand-short-name }.
...
addon-install-error-soft-blocked = התוספת { $addonName } מפרה את המדיניות של BrowserWorks ולכן לא ניתן להתקין אותה ב־{ -brand-short-name }.
