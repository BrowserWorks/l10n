...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = ההרחבה { $extensionName } מפרה את המדיניות של BrowserWorks. השימוש בה עשוי להיות כרוך בסיכון.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = ההרחבה { $extensionName } מושבתת
    .message =
        הרחבה זו מפרה את המדיניות של BrowserWorks ולכן הושבתה.
        באפשרותך להפעיל אותה בהגדרות, אבל ייתכן שזה יהיה כרוך בסיכון.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = ההרחבה { $extensionName } מושבתת
    .message = הרחבה זו מפרה את המדיניות של BrowserWorks ולכן הושבתה.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        חלק מההרחבות שלך הושבתו עקב הפרת המדיניות של BrowserWorks.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = חלק מההרחבות שלך הושבתו עקב הפרת המדיניות של BrowserWorks.
