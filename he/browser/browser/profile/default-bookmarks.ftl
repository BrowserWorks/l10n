...
default-bookmarks-firefox-customize = התאמה אישית של Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = השתתפות
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = על אודותינו
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = משאבים עבור Waterfox Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = הבלוג של Waterfox Nightly
