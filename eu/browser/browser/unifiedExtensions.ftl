...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } hedapenak BrowserWorksren politikak bortxatzen ditu. Arriskutsua izan liteke hau erabiltzea.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } desgaituta
    .message =
        Hedapen honek BrowserWorksren politikak bortxatzen ditu eta desgaitu egin da.
        Ezarpenetan gaitzeko aukera daukazu baina arriskutsua izan liteke.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } desgaituta
    .message = Hedapen honek BrowserWorksren politikak bortxatzen ditu eta desgaitu egin da.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Zure zenbait hedapen desgaitu egin dira BrowserWorksren politikak bortxatzen dituztelako.
        Ezarpenetan gaitzeko aukera daukazu baina arriskutsua izan liteke.
# Variables:
