...
addon-install-error-hard-blocked = { $addonName } gehigarriak BrowserWorksren politikak bortxatzen ditu eta ezin da { -brand-short-name }(e)n instalatu.
...
addon-install-error-soft-blocked = { $addonName } gehigarriak BrowserWorksren politikak bortxatzen ditu eta ezin da { -brand-short-name }(e)n instalatu.
