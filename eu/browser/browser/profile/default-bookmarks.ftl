...
default-bookmarks-firefox-customize = Pertsonalizatu Waterfox
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Parte hartu
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Guri buruz
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Waterfox Nightly baliabideak
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Waterfox Nightly bloga
