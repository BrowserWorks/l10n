...
urlbar-serial-notification-anchor =
    .tooltiptext = Ireki serieko gailuen panela
...
identity-custom-root = BrowserWorksk onetsi gabeko ziurtagiri-jaulkitzaile batek egiaztatu du konexioa.
...
identity-description-custom-root2 = BrowserWorksk ez du ziurtagiri-jaulkitzaile hau ontzat hartzen. Zure sistema eragileak edo administratzaile batek gehitu du agian.
...
urlbar-result-action-move-tab-to-split-view = Eraman fitxa ikuspegi zatitura
...
urlbar-result-addons-subtitle = { -brand-product-name } hedapena
...
urlbar-result-suggestion-recommended = Gomendatua
...
urlbar-result-explanation-last-visited-relative = Azkenekoz bisitatutako data: { $date }
...
urlbar-result-explanation-last-visited-days =
    { $daysAgo ->
        [one] Azkenekoz atzo bisitatu zenuen
       *[other] Azkenekoz duela { $daysAgo } egun bisitatu zenuen
    }
...
urlbar-result-explanation-last-visited-weeks =
    { $weeksAgo ->
        [one] Azkenekoz duela aste { $weeksAgo } bisitatu zenuen
       *[other] Azkenekoz duela { $weeksAgo } aste bisitatu zenuen
    }
...
urlbar-result-explanation-last-visited-months =
    { $monthsAgo ->
        [one] Azkenekoz duela hilabete bisitatu zenuen
       *[other] Azkenekoz duela { $monthsAgo } hilabete bisitatu zenuen
    }
# This explanation is used when the last-visited date is further in the past.
# The date will be formatted as an absolute date like: "11 May", "11 May 2026"
# Variables:
#   $date (string) - A localized absolute date string
urlbar-result-explanation-last-visited-absolute = Azkenekoz ondorengo datan bisitatu zenuen: { $date }
...
urlbar-result-dates-ongoing =
    { $daysUntilEnd ->
        [one] { $name } · Egun { $daysUntilEnd } barru bukatzen da
       *[other] { $name } · { $daysUntilEnd } egun barru bukatzen da
    }
...
qrcode-panel-error =
    .message = Huts egin du QR kodea sortzean. Saiatu berriro mesedez.
qrcode-copy-button =
    .label = Kopiatu
qrcode-copy-success =
    .message = QR kodea arbelean kopiatu da.
qrcode-copy-error =
    .message = Huts egin du QR kodea kopiatzerakoan.
qrcode-save-button =
    .label = Gorde
qrcode-save-success =
    .message = QR kodea gordeta.
qrcode-save-error =
    .message = Huts egin du QR kodea gordetzean.
qrcode-save-title = Gorde QR kodea
qrcode-save-filter-png = PNG irudia
qrcode-save-filename = qrcode.png
qrcode-window-title = QR kodea
qrcode-dialog-title = QR kodea
qrcode-image =
    .aria-label = QR kodea
qrcode-close-button =
    .aria-label = Itxi
...
urlbar-trust-icon-notsecure-label = Ez-segurua
