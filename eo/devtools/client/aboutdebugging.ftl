...
about-debugging-browser-version-too-old-fennec = Tiu ĉi versio de Waterfox ne povas senerarigi  Waterfox for Android (68). Ni rekomendas instalon de Waterfox for Android Nightly en vi telefono por testado. <a>Pli da informo</a>
