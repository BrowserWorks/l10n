...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } malobservas la politikojn de BrowserWorks. Uzi ĝin povas esti riske.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } malaktivigita
    .message = Tiu ĉi etendaĵo malobservas politikojn de BrowserWorks kaj ĝi estis do malaktivigita. Vi povas reaktivigi ĝin en la agordoj, sed tio povus esti riske.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } malaktivigita
    .message = Tiu ĉi etendaĵo malobservas politikojn de BrowserWorks kaj ĝi estis do malaktivigita.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message = Kelkaj el viaj etendaĵoj malobservas politikojn de BrowserWorks kaj ili estis do malaktivigitaj. Vi povas reaktivigi ilin en la agordoj, sed tio povus esti riske.
# Variables:
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Kelkaj el viaj etendaĵoj malobservas politikojn de BrowserWorks kaj ili estis do malaktivigitaj.
