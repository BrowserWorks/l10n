...
addon-install-error-hard-blocked = { $addonName } malobservas politikojn de BrowserWorks kaj ne povas esti instalita en { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } malobservas politikojn de BrowserWorks kaj ne povas esti instalita en { -brand-short-name }.
