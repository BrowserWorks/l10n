...
onboarding-animation-pause-button =
    .aria-label = Animaasjes pauzearje
onboarding-animation-play-button =
    .aria-label = Animaasjes ôfspylje
...
mr2022-onboarding-gratitude-subtitle = Tank foar it brûken fan { -brand-short-name }, stipe troch de BrowserWorks. Mei jo stipe wurkje wy om it ynternet iepener, tagonkliker en better te meitsjen foar elkenien.
...
onboarding-gratitude-security-and-privacy-subtitle = Tank foar it brûken fan { -brand-short-name }, stipe troch de BrowserWorks. Mei jo stipe wurkje wy om it ynternet  foar elkenien feiliger en mear tagonklik te meitsjen.
