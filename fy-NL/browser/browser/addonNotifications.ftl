...
addon-install-error-hard-blocked = { $addonName } skeint it belied fan BrowserWorks en kin net ynstallearre wurde op { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } skeint it belied fan BrowserWorks en kin net ynstallearre wurde op { -brand-short-name }.
