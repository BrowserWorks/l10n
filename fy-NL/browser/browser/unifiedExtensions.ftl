...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } skeint it belied fan BrowserWorks. It brûken hjirfan kin gefaarlik wêze.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } útskeakele
    .message =
        Dizze útwreiding skeint BrowserWorks-belied en is utskeakele.
        Jo kinne it yn jo ynstellingen wer ynskeakelje, mar dit kin risikofol wêze.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } útskeakele
    .message = Dizze útwreiding skeint BrowserWorks-belied en is útskeakele.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Guon fan jo útwreidingen binne útskeakele fanwegen skeining fan BrowserWorks-belied.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Guon fan jo útwreidingen binne útskeakele fanwegen skeining fan BrowserWorks-belied.
