...
cert-error-mitm-mozilla = { -brand-short-name } wurdt stipe troch de non-profitorganisaasje BrowserWorks, dy’t in folslein iepen argyf foar sertifikaatautoriteiten (CA) beheart. It CA-argyf helpt te fersekerjen dat sertifikaatautoriteiten de bêste prosedueren foar brûkersbefeiliging folgje.
cert-error-mitm-connection = { -brand-short-name } brûkt it CA-argyf fan BrowserWorks om te ferifiearjen dat in ferbining befeilige is yn stee fan sertifikaten dy’t troch it bestjoeringssysteem fan de brûker levere wurde. As in antifirusprogramma of in netwurk dus in ferbining ûnderskept mei in troch in CA útjûn befeiligingssertifikaat dat him yn it CA-argyf fan BrowserWorks stiet, wurdt de ferbining as ûnfeilich beskôge.
