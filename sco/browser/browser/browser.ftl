...
identity-custom-root = Connection verified by a certificate issuer that isnae kent by BrowserWorks.
...
identity-description-custom-root2 = BrowserWorks disnae ken this certificate issuer. It micht hae been eikit on fae yer operatin system or by an admeenistrator.
