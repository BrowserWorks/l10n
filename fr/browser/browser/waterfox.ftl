...
show-copy-url =
    .label = Afficher l'élément de menu « copier l'URL de l'onglet »
show-duplicate-tab =
    .label = Afficher l'élément de menu « Onglet dupliqué »
show-unload-tab =
    .label = Afficher l'élément de menu « Décharger »
preferences-doh-setting-ultra =
    .label = Ultra Protection
    .accesskey = U
preferences-doh-ultra-desc = { -brand-short-name } utilisera un DNS sécurisé avec le protocole Oblivious HTTP via le relais de confidentialité de Waterfox pour une protection optimale.
