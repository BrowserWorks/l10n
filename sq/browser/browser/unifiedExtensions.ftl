...
# Variables:
#   $extensionName (String) - Name of the user-enabled soft-blocked extension.
unified-extensions-item-messagebar-softblocked = { $extensionName } cenon rregullat e BrowserWorks-s. Përdorimi i saj mund të jetë me rrezik.
...
unified-extensions-mb-blocklist-warning-single =
    .heading = { $extensionName } u çaktivizua
    .message =
        Ky zgjerim cenon rregulla të BrowserWorks-s dhe është çaktivizuar.
        Mund ta aktivizoni te rregullimet, por kjo mund të jetë me rrezik.
# Variables:
#   $extensionName (String) - Name of the extension disabled through a hard-block.
unified-extensions-mb-blocklist-error-single =
    .heading = { $extensionName } u çaktivizua
    .message = Ky zgjerim cenon rregulla të BrowserWorks-s dhe është çaktivizuar.
# Variables:
...
unified-extensions-mb-blocklist-warning-multiple =
    ...
    .message =
        Disa nga zgjerimet tuaja janë çaktivizuar, pasi cenojnë rregulla të BrowserWorks-s.
...
unified-extensions-mb-blocklist-error-multiple =
    ...
    .message = Disa nga zgjerimet tuaja janë çaktivizuar, pasi cenojnë rregulla të BrowserWorks-s.
