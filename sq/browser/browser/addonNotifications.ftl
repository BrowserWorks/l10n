...
addon-install-error-hard-blocked = { $addonName } cenon rregullat e BrowserWorks-s dhe s’mund të instalohet në { -brand-short-name }.
...
addon-install-error-soft-blocked = { $addonName } cenon rregullat e BrowserWorks-s dhe s’mund të instalohet në { -brand-short-name }.
