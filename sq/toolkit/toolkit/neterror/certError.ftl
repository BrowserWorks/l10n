...
cert-error-mitm-mozilla = { -brand-short-name } ka nga pas entin jofitimprurës BrowserWorks, i cili administron një arkiv tërësisht të hapur autoriteti dëshmish (AD). Arkivi AD ndihmon të garantohet se autoritetet e dëshmive ndjekin praktikat më të mirë mbi sigurinë e përdoruesve.
cert-error-mitm-connection = { -brand-short-name }-i përdor arkivin AD të BrowserWorks-s për të verifikuar se një lidhje është e siguruar, në vend se dëshmi të furnizuara nga sistemi operativ i përdoruesit. Kështu, nëse një program antivirus apo një rrjet përgjon një lidhje me një dëshmi sigurie të lëshuar nga një Autoritet Dëshmish që s’gjendet te arkivi AD BrowserWorks, lidhja konsiderohet jo e parrezik.
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-certerror-untrusted-issuer-why-dangerous-body = { -brand-short-name }-i po ju sinjalizon rreth këtij sajti, ngaqë dëshmia e dhënë për { $hostname } qe lëshuar nga një autoritet dëshmish që s’është më i besueshëm.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
fp-certerror-untrusted-issuer-what-can-you-do-body = Me gjasa asgjë, ngaqë ka shumë mundësi të ketë një problem me vetë sajtin. Mund të bisedoni me të zotin e sajtit, për të parë nëse po merret me problemin.
# This string appears after the following string: "What makes the site look dangerous?" (fp-certerror-why-site-dangerous)
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-certerror-transparency-why-dangerous-body = { -brand-short-name } s’i zë besë { $hostname }, ngaqë s’provoi dot se plotëson domosdoshmëri transparence dëshmish.
# This string appears after the following string: "What can you do about it?" (fp-certerror-what-can-you-do)
fp-certerror-transparency-what-can-you-do-body = Ka shumë mundësi asgjë, ngaqë gjasat janë se pati një problem me vetë sajtin.
...
# Variables:
#   $hostname (String) - Hostname of the website to which the user was trying to connect.
fp-certerror-invalid-cert-why-dangerous = I zoti i { $hostname } s’e ka ujdisur si duhet dhe s’mund të krijohet një lidhje e siguruar.
