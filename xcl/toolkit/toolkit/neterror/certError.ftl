...
cert-error-mitm-mozilla = { -brand-short-name } հոգացեալ է ընդ հովանեաւ յոր զհետ շահութի չէ պնդեալ BrowserWorks֊է, որ կառավարէ զհամաւրէն բաց շտեմարան հաւաստագրող ատենից։  Այս շտեմարան աւգնէ երաշխաւորել, զի հաւաստագրող ատեանք ըստ ամենայնի պահպանեն զանվտանգութիւն աւգտատեարց։
