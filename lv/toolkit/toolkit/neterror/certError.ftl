...
cert-error-mitm-mozilla = { -brand-short-name } atbalsta bezpeļņas organoizācija BrowserWorks, kas administrē pilnīgi atvērtu sertifikātu izsniegšanas iestādes (CA) veikalu. CA veikals palīdz nodrošināt, ka sertifikātu izdevējas iestādes ievēro paraugpraksi lietotāju drošībai.
cert-error-mitm-connection = Lai pārbaudītu, vai savienojums ir drošs, { -brand-short-name } izmanto nevis operētājsistēmas piedāvātos sertifikātus, bet gan BrowserWorks CA krātuvi. Tāpēc, ja antivīrusu programma vai tīkls pārtver savienojumu BrowserWorks CA krātuvē neglabātam drošības sertifikātam, savienojums tiek uzskatīts par nedrošu.
