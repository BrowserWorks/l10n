...
addon-install-error-hard-blocked = { $addonName } pārkāpj BrowserWorks pamatnostādnes, un to { -brand-short-name } nevar instalēt.
...
addon-install-error-soft-blocked = { $addonName } pārkāpj BrowserWorks pamatnostādnes, un to { -brand-short-name } nevar instalēt.
