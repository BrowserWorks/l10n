...
protections-panel-content-blocking-breakage-report-view-description = Dažu izsekotāju bloķēšana var radīt problēmas ar dažām vietnēm. Ziņošana par šīm problēmām palīdz padarīt { -brand-short-name } labāku ikvienam. Nosūtot šo ziņojumu, BrowserWorks tiks nosūtīts URL un informācija par jūsu pārlūkprogrammas iestatījumiem. <label data-l10n-name="learn-more">Uzziniet vairāk</label>
