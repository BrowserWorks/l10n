...
identity-custom-root = Savienojumu ir pārbaudījis sertifikāta izdevējs, kuru BrowserWorks neatpazīst.
...
identity-description-custom-root2 = BrowserWorks neatpazīst šo sertifikāta izdevēju. Iespējams, to ir pievienojis jūsu operētājsistēma vai administrators.
